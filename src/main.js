...
window.restartShopScanner = restartShopScanner; // Re-activate scanner after stopping
...
window.restartInvScanner = restartInvScanner; // Re-activate scanner after stopping
