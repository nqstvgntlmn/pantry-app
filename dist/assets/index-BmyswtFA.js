 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gn(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function uh(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hp="FirebaseError";class yt extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Hp,Object.setPrototypeOf(this,yt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Yi.prototype.create)}}class Yi{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],a=r?qp(r,i):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new yt(s,c,i)}}function qp(n,e){return n.replace(zp,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const zp=/\{\$([^}]+)}/g;function Wp(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function fn(n,e){if(n===e)return!0;const t=Object.keys(n),i=Object.keys(e);for(const s of t){if(!i.includes(s))return!1;const r=n[s],a=e[s];if(vl(r)&&vl(a)){if(!fn(r,a))return!1}else if(r!==a)return!1}for(const s of i)if(!t.includes(s))return!1;return!0}function vl(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft=new pa("@firebase/app"),ym="@firebase/app-compat",vm="@firebase/analytics-compat",wm="@firebase/analytics",_m="@firebase/app-check-compat",bm="@firebase/app-check",Tm="@firebase/auth",Em="@firebase/auth-compat",Im="@firebase/database",Sm="@firebase/data-connect",Am="@firebase/database-compat",km="@firebase/functions",Cm="@firebase/functions-compat",Rm="@firebase/installations",Pm="@firebase/installations-compat",xm="@firebase/messaging",Lm="@firebase/messaging-compat",Dm="@firebase/performance",Nm="@firebase/performance-compat",Mm="@firebase/remote-config",Om="@firebase/remote-config-compat",Vm="@firebase/storage",$m="@firebase/storage-compat",Fm="@firebase/firestore",Um="@firebase/ai",jm="@firebase/firestore-compat",Bm="firebase",Hm="12.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oo="[DEFAULT]",qm={[Mo]:"fire-core",[ym]:"fire-core-compat",[wm]:"fire-analytics",[vm]:"fire-analytics-compat",[bm]:"fire-app-check",[_m]:"fire-app-check-compat",[Tm]:"fire-auth",[Em]:"fire-auth-compat",[Im]:"fire-rtdb",[Sm]:"fire-data-connect",[Am]:"fire-rtdb-compat",[km]:"fire-fn",[Cm]:"fire-fn-compat",[Rm]:"fire-iid",[Pm]:"fire-iid-compat",[xm]:"fire-fcm",[Lm]:"fire-fcm-compat",[Dm]:"fire-perf",[Nm]:"fire-perf-compat",[Mm]:"fire-rc",[Om]:"fire-rc-compat",[Vm]:"fire-gcs",[$m]:"fire-gcs-compat",[Fm]:"fire-fst",[jm]:"fire-fst-compat",[Um]:"fire-vertex","fire-js":"fire-js",[Bm]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $o(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function cg(){return kl()==="http:"||kl()==="https:"}function kl(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zs(n){var _;const e=n.auth,t=await n.getIdToken(),i=await Fn(n,Xs(e,{idToken:t}));F(i==null?void 0:i.users.length,e,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const r=(_=s.providerUserInfo)!=null&&_.length?Ih(s.providerUserInfo):[],a=Eg(n.providerData,r),c=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=c?u:!1,m={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Fo(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,m)}async function Tg(n){const e=je(n);await Zs(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Eg(n,e){return[...n.filter(i=>!e.some(s=>s.providerId===i.providerId)),...e]}function Ih(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ll(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Rh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ah(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(xh(e))return"Blackberry";if(Lh(e))return"Webos";if(kh(e))return"Safari";if((e.includes("chrome/")||Ch(e))&&!e.includes("edge/"))return"Chrome";if(Ph(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Ah(n=Se()){return/firefox\//i.test(n)}function kh(n=Se()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ch(n=Se()){return/crios\//i.test(n)}function Rh(n=Se()){return/iemobile/i.test(n)}function Ph(n=Se()){return/android/i.test(n)}function xh(n=Se()){return/blackberry/i.test(n)}function Lh(n=Se()){return/webos/i.test(n)}function ba(n=Se()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Ag(n=Se()){var e;return ba(n)&&!!((e=window.navigator)!=null&&e.standalone)}function kg(){return Fp()&&document.documentMode===10}function Dh(n=Se()){return ba(n)||Ph(n)||Lh(n)||xh(n)||/windows phone/i.test(n)||Rh(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cg{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,t){const i=r=>new Promise((a,c)=>{try{const u=e(r);a(u)}catch(u){c(u)}});i.onAbort=t,this.queue.push(i);const s=this.queue.length-1;return()=>{this.queue[s]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const t=[];try{for(const i of this.queue)await i(e),i.onAbort&&t.push(i.onAbort)}catch(i){t.reverse();for(const s of t)try{s()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:i==null?void 0:i.message})}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gg(n,e){return es(n,"POST","/v1/accounts:signInWithPassword",Jt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cv="__/auth/handler",lv="emulator/auth/handler",uv=encodeURIComponent("fac");async function Bl(n,e,t,i,s,r){F(n.config.authDomain,n,"auth-domain-config-required"),F(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:Kn,eventId:s};if(e instanceof yr){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",Wp(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[m,_]of Object.entries({}))a[m]=_}if(e instanceof Jn){const m=e.getScopes().filter(_=>_!=="");m.length>0&&(a.scopes=m.join(","))}n.tenantId&&(a.tid=n.tenantId);const c=a;for(const m of Object.keys(c))c[m]===void 0&&delete c[m];const u=await n._getAppCheckToken(),d=u?`#${uv}=${encodeURIComponent(u)}`:"";return`${hv(n)}?${Xi(c).slice(1)}${d}`}function hv({config:n}){return n.emulator?wa(n,lv):`https://${n.authDomain}/${cv}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vw=-1;function Sr(n){return n==null}function Wo(n){return n===0&&1/n==-1/0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ew{constructor(e,t,i,s,r,a,c,u,d,m,_){this.databaseId=e,this.appId=t,this.persistenceKey=i,this.host=s,this.ssl=r,this.forceLongPolling=a,this.autoDetectLongPolling=c,this.longPollingOptions=u,this.useFetchStreams=d,this.isUsingEmulator=m,this.apiKey=_}}const sr="(default)";class Wi{constructor(e,t){this.projectId=e,this.database=t||sr}static empty(){return new Wi("","")}get isDefaultDatabase(){return this.database===sr}isEqual(e){return e instanceof Wi&&e.projectId===this.projectId&&e.database===this.database}}function Iw(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new V(L.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Wi(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yw(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Wo(e)?"-0":e}}function Xw(n){return{integerValue:""+n}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k_{constructor(e){this.yt=e}}function C_(n){const e=T_({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Xo(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class R_{constructor(){this.Sn=new P_}addToCollectionParentIndex(e,t){return this.Sn.add(t),C.resolve()}getCollectionParents(e,t){return C.resolve(this.Sn.getEntries(t))}addFieldIndex(e,t){return C.resolve()}deleteFieldIndex(e,t){return C.resolve()}deleteAllFieldIndexes(e){return C.resolve()}createTargetIndexes(e,t){return C.resolve()}getDocumentsMatchingTarget(e,t){return C.resolve(null)}getIndexType(e,t){return C.resolve(0)}getFieldIndexes(e,t){return C.resolve([])}getNextCollectionGroupToUpdate(e){return C.resolve(null)}getMinOffset(e,t){return C.resolve(qt.min())}getMinOffsetFromCollectionGroup(e,t){return C.resolve(qt.min())}updateCollectionGroup(e,t,i){return C.resolve()}updateIndexEntries(e,t){return C.resolve()}}class P_{constructor(){this.index={}}add(e){const t=e.lastSegment(),i=e.popLast(),s=this.index[t]||new ge(se.comparator),r=!s.has(i);return this.index[t]=s.add(i),r}has(e){const t=e.lastSegment(),i=e.popLast(),s=this.index[t];return s&&s.has(i)}getEntries(e){return(this.index[e]||new ge(se.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _u={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},Gd=41943040;class Me{static withCacheSize(e){return new Me(e,Me.DEFAULT_COLLECTION_PERCENTILE,Me.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(e,t,i){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Me.DEFAULT_COLLECTION_PERCENTILE=10,Me.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Me.DEFAULT=new Me(Gd,Me.DEFAULT_COLLECTION_PERCENTILE,Me.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Me.DISABLED=new Me(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O_{constructor(){this.changes=new wn((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ie.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const i=this.changes.get(t);return i!==void 0?C.resolve(i):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F_{constructor(e){this.serializer=e,this.Nr=new Map,this.Br=new Map}getBundleMetadata(e,t){return C.resolve(this.Nr.get(t))}saveBundleMetadata(e,t){return this.Nr.set(t.id,(function(s){return{id:s.id,version:s.version,createTime:Dn(s.createTime)}})(t)),C.resolve()}getNamedQuery(e,t){return C.resolve(this.Br.get(t))}saveNamedQuery(e,t){return this.Br.set(t.name,(function(s){return{name:s.name,query:C_(s.bundledQuery),readTime:Dn(s.readTime)}})(t)),C.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kd{constructor(e,t){this._i={},this.overlays={},this.ai=new Ir(0),this.ui=!1,this.ui=!0,this.ci=new j_,this.referenceDelegate=e(this),this.li=new z_(this),this.indexManager=new R_,this.remoteDocumentCache=(function(s){return new H_(s)})((i=>this.referenceDelegate.hi(i))),this.serializer=new k_(t),this.Pi=new F_(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.ui=!1,Promise.resolve()}get started(){return this.ui}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new U_,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let i=this._i[e.toKey()];return i||(i=new B_(t,this.referenceDelegate),this._i[e.toKey()]=i),i}getGlobalsCache(){return this.ci}getTargetCache(){return this.li}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Pi}runTransaction(e,t,i){D("MemoryPersistence","Starting transaction:",e);const s=new W_(this.ai.next());return this.referenceDelegate.Ti(),i(s).next((r=>this.referenceDelegate.Ii(s).next((()=>r)))).toPromise().then((r=>(s.raiseOnCommittedEvent(),r)))}Ei(e,t){return C.or(Object.values(this._i).map((i=>()=>i.containsKey(e,t))))}}class W_ extends gw{constructor(e){super(),this.currentSequenceNumber=e}}class Ha{constructor(e){this.persistence=e,this.Ri=new Ba,this.Ai=null}static Vi(e){return new Ha(e)}get di(){if(this.Ai)return this.Ai;throw H(60996)}addReference(e,t,i){return this.Ri.addReference(i,t),this.di.delete(i.toString()),C.resolve()}removeReference(e,t,i){return this.Ri.removeReference(i,t),this.di.add(i.toString()),C.resolve()}markPotentiallyOrphaned(e,t){return this.di.add(t.toString()),C.resolve()}removeTarget(e,t){this.Ri.Gr(t.targetId).forEach((s=>this.di.add(s.toString())));const i=this.persistence.getTargetCache();return i.getMatchingKeysForTargetId(e,t.targetId).next((s=>{s.forEach((r=>this.di.add(r.toString())))})).next((()=>i.removeTargetData(e,t)))}Ti(){this.Ai=new Set}Ii(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return C.forEach(this.di,(i=>{const s=U.fromPath(i);return this.mi(e,s).next((r=>{r||t.removeEntry(s,B.min())}))})).next((()=>(this.Ai=null,t.apply(e))))}updateLimboDocument(e,t){return this.mi(e,t).next((i=>{i?this.di.delete(t.toString()):this.di.add(t.toString())}))}hi(e){return 0}mi(e,t){return C.or([()=>C.resolve(this.Ri.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ei(e,t)])}}class lr{constructor(e,t){this.persistence=e,this.fi=new wn((i=>ww(i.path)),((i,s)=>i.isEqual(s))),this.garbageCollector=M_(this,t)}static Vi(e,t){return new lr(e,t)}Ti(){}Ii(e){return C.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}dr(e){const t=this.pr(e);return this.persistence.getTargetCache().getTargetCount(e).next((i=>t.next((s=>i+s))))}pr(e){let t=0;return this.mr(e,(i=>{t++})).next((()=>t))}mr(e,t){return C.forEach(this.fi,((i,s)=>this.wr(e,i,s).next((r=>r?C.resolve():t(s)))))}removeTargets(e,t,i){return this.persistence.getTargetCache().removeTargets(e,t,i)}removeOrphanedDocuments(e,t){let i=0;const s=this.persistence.getRemoteDocumentCache(),r=s.newChangeBuffer();return s.ni(e,(a=>this.wr(e,a,t).next((c=>{c||(i++,r.removeEntry(a,B.min()))})))).next((()=>r.apply(e))).next((()=>i))}markPotentiallyOrphaned(e,t){return this.fi.set(t,e.currentSequenceNumber),C.resolve()}removeTarget(e,t){const i=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,i)}addReference(e,t,i){return this.fi.set(i,e.currentSequenceNumber),C.resolve()}removeReference(e,t,i){return this.fi.set(i,e.currentSequenceNumber),C.resolve()}updateLimboDocument(e,t){return this.fi.set(t,e.currentSequenceNumber),C.resolve()}hi(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=js(e.data.value)),t}wr(e,t,i){return C.or([()=>this.persistence.Ei(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{const s=this.fi.get(t);return C.resolve(s!==void 0&&s>i)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K_{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return Up()?8:yw(Se())>0?6:4})()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,i,s){const r={result:null};return this.gs(e,t).next((a=>{r.result=a})).next((()=>{if(!r.result)return this.ps(e,t,s,i).next((a=>{r.result=a}))})).next((()=>{if(r.result)return;const a=new G_;return this.ys(e,t,a).next((c=>{if(r.result=c,this.As)return this.ws(e,t,a,c.size)}))})).next((()=>r.result))}ws(e,t,i,s){return i.documentReadCount<this.Vs?(Sn()<=z.DEBUG&&D("QueryEngine","SDK will not create cache indexes for query:",An(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),C.resolve()):(Sn()<=z.DEBUG&&D("QueryEngine","Query:",An(t),"scans",i.documentReadCount,"local documents and returns",s,"documents as results."),i.documentReadCount>this.ds*s?(Sn()<=z.DEBUG&&D("QueryEngine","The SDK decides to create cache indexes for query:",An(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,st(t))):C.resolve())}gs(e,t){if(uu(t))return C.resolve(null);let i=st(t);return this.indexManager.getIndexType(e,i).next((s=>s===0?null:(t.limit!==null&&s===1&&(t=Xo(t,null,"F"),i=st(t)),this.indexManager.getDocumentsMatchingTarget(e,i).next((r=>{const a=Y(...r);return this.fs.getDocuments(e,a).next((c=>this.indexManager.getMinOffset(e,i).next((u=>{const d=this.bs(t,c);return this.Ss(t,d,a,u.readTime)?this.gs(e,Xo(t,null,"F")):this.Ds(e,d,t,u)}))))})))))}ps(e,t,i,s){return uu(t)||s.isEqual(B.min())?C.resolve(null):this.fs.getDocuments(e,i).next((r=>{const a=this.bs(t,r);return this.Ss(t,a,i,s)?C.resolve(null):(Sn()<=z.DEBUG&&D("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),An(t)),this.Ds(e,a,t,dw(s,qi)).next((c=>c)))}))}bs(e,t){let i=new ge(Pd(e));return t.forEach(((s,r)=>{Rr(e,r)&&(i=i.add(r))})),i}Ss(e,t,i,s){if(e.limit===null)return!1;if(i.size!==t.size)return!0;const r=e.limitType==="F"?t.last():t.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(s)>0)}ys(e,t,i){return Sn()<=z.DEBUG&&D("QueryEngine","Using full collection scan to execute query:",An(t)),this.fs.getDocumentsMatchingQuery(e,t,qt.min(),i)}Ds(e,t,i,s){return this.fs.getDocumentsMatchingQuery(e,i,s).next((r=>(t.forEach((a=>{r=r.insert(a.key,a)})),r)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qn="RemoteStore";class pb{constructor(e,t,i,s,r){this.localStore=e,this.datastore=t,this.asyncQueue=i,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.Ra=[],this.Aa=r,this.Aa.Mo((a=>{i.enqueueAndForget((async()=>{os(this)&&(D(qn,"Restarting streams for network reachability change."),await(async function(u){const d=J(u);d.Ea.add(4),await rs(d),d.Va.set("Unknown"),d.Ea.delete(4),await Dr(d)})(this))}))})),this.Va=new fb(i,s)}}async function Dr(n){if(os(n))for(const e of n.Ra)await e(!0)}async function rs(n){for(const e of n.Ra)await e(!1)}function Zd(n,e){const t=J(n);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),Qa(t)?Ka(t):ni(t).O_()&&Ga(t,e))}function Wa(n,e){const t=J(n),i=ni(t);t.Ia.delete(e),i.O_()&&ef(t,e),t.Ia.size===0&&(i.O_()?i.L_():os(t)&&t.Va.set("Unknown"))}function Ga(n,e){if(n.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(B.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}ni(n).Z_(e)}function ef(n,e){n.da.$e(e),ni(n).X_(e)}function Ka(n){n.da=new u_({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),ni(n).start(),n.Va.ua()}function Qa(n){return os(n)&&!ni(n).x_()&&n.Ia.size>0}function os(n){return J(n).Ea.size===0}function tf(n){n.da=void 0}async function mb(n){n.Va.set("Online")}async function gb(n){n.Ia.forEach(((e,t)=>{Ga(n,e)}))}async function yb(n,e){tf(n),Qa(n)?(n.Va.ha(e),Ka(n)):n.Va.set("Unknown")}async function vb(n,e,t){if(n.Va.set("Online"),e instanceof Ud&&e.state===2&&e.cause)try{await(async function(s,r){const a=r.cause;for(const c of r.targetIds)s.Ia.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s.Ia.delete(c),s.da.removeTarget(c))})(n,e)}catch(i){D(qn,"Failed to remove targets %s: %s ",e.targetIds.join(","),i),await Cu(n,i)}else if(e instanceof Hs?n.da.Xe(e):e instanceof Fd?n.da.st(e):n.da.tt(e),!t.isEqual(B.min()))try{const i=await Jd(n.localStore);t.compareTo(i)>=0&&await(function(r,a){const c=r.da.Tt(a);return c.targetChanges.forEach(((u,d)=>{if(u.resumeToken.approximateByteSize()>0){const m=r.Ia.get(d);m&&r.Ia.set(d,m.withResumeToken(u.resumeToken,a))}})),c.targetMismatches.forEach(((u,d)=>{const m=r.Ia.get(u);if(!m)return;r.Ia.set(u,m.withResumeToken(_e.EMPTY_BYTE_STRING,m.snapshotVersion)),ef(r,u);const _=new Dt(m.target,u,d,m.sequenceNumber);Ga(r,_)})),r.remoteSyncer.applyRemoteEvent(c)})(n,t)}catch(i){D(qn,"Failed to raise snapshot:",i),await Cu(n,i)}}async function Cu(n,e,t){if(!ti(e))throw e;n.Ea.add(1),await rs(n),n.Va.set("Offline"),t||(t=()=>Jd(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{D(qn,"Retrying IndexedDB access"),await t(),n.Ea.delete(1),await Dr(n)}))}async function Ru(n,e){const t=J(n);t.asyncQueue.verifyOperationInProgress(),D(qn,"RemoteStore received new credentials");const i=os(t);t.Ea.add(3),await rs(t),i&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Dr(t)}async function wb(n,e){const t=J(n);e?(t.Ea.delete(2),await Dr(t)):e||(t.Ea.add(2),await rs(t),t.Va.set("Unknown"))}function ni(n){return n.ma||(n.ma=(function(t,i,s){const r=J(t);return r.sa(),new lb(i,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)})(n.datastore,n.asyncQueue,{Zo:mb.bind(null,n),Yo:gb.bind(null,n),t_:yb.bind(null,n),J_:vb.bind(null,n)}),n.Ra.push((async e=>{e?(n.ma.B_(),Qa(n)?Ka(n):n.Va.set("Unknown")):(await n.ma.stop(),tf(n))}))),n.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wb="ComponentProvider",Vu=new Map;function Gb(n,e,t,i,s){return new Ew(n,e,t,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,hf(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),e=f("expbox");e&&(e.textContent=n||"No items yet.")}let Be=null,ko=!1,Ti="",Co=!1;function fT(){if(!(window.SpeechRecognition||window.webkitSpeechRecognition))return;const e=f("shopAddMicOpt");e&&(e.style.display="")}function Wu(n){const e=f("micstatus");e&&e.classList.toggle("visible",n)}function _f(){if(ko&&Be){Co=!0,Be.stop();return}const n=window.SpeechRecognition||window.webkitSpeechRecognition;if(!n){P("Voice input not supported");return}Be=new n,Be.lang="en-US",Be.interimResults=!0,Be.maxAlternatives=1,Be.continuous=!1,Ti="",ko=!0,Wu(!0),Be.onresult=e=>{let t="";for(let s=e.resultIndex;s<e.results.length;s++){const r=e.results[s][0].transcript;e.results[s].isFinal?Ti+=r:t+=r}const i=f("shi");i&&(i.value=(Ti+t).trim())},Be.onerror=e=>{e.error!=="no-speech"&&e.error!=="aborted"&&P("Couldn't hear that — try again")},Be.onend=()=>{let e=(Ti||"").trim();if(!e&&Co){const t=f("shi");e=t?t.value.trim():""}if(ko=!1,Be=null,Ti="",Co=!1,Wu(!1),e){let t=e,i=1;const s=e.match(/^(\d+)\s+(.+)/),r=e.match(/^(.+?)\s*[x×]\s*(\d+)$/i);r?(t=r[1].trim(),i=parseInt(r[2],10)||1):s&&(t=s[2].trim(),i=parseInt(s[1],10)||1);const a={id:Date.now().toString(),name:t,qty:i,checked:!1,src:"manual"};Ve(a),P(`Added "${e}" 🎤`);const c=f("shi");c&&(c.value=""),Mr(a.id,t,"shop")}},Be.start()}function xs(n){const e=n.qty||1,t=`<span class="sh-qty${e===1?" sh-qty-one":""}" onclick="event.stopPropagation();openShQty('${n.id}')"> × ${e}</span>`,i=n.image?`<img src="${n.image}" class="sh-thumb" alt="" onerror="this.style.display='none'"/>`:"";return`<div class="swipe-wrap" id="sw-${n.id}" data-id="${n.id}" data-list="shop">
    ...
    <div style="flex:1;min-width:0">
      ...
      </div>`)}s+='<button class="btn bs bf" onclick="closeItemDetail()" style="margin-top:8px">Close</button>',t.innerHTML=s;const c=f("itemDetailBackdrop"),u=f("itemDetailSheet");c&&c.classList.add("active"),u&&u.classList.add("active")}function ST(){const n=f("itemDetailBackdrop"),e=f("itemDetailSheet");n&&n.classList.remove("active"),e&&e.classList.remove("active")}function AT(n){const e=window._enrichCtx;if(!e)return;const t=e.results[n];if(t){if(e.list==="shop"){const i=p.shop.find(s=>s.id===e.itemId);i&&Ve({...i,name:t.name,brand:t.brand||"",image:t.image||null,category:t.category||"",nutrition:t.nutrition||null,source:t.source||"search"})}else if(e.list==="inv"){const i=p.inv.find(s=>s.id===e.itemId);i&&ke({...i,name:t.name,brand:t.brand||"",image:t.image||null,category:t.category||i.category,nutrition:t.nutrition||null,source:t.source||"search"})}hr(),P(`Updated with "${t.name}" ✓`)}}function Ef(n){if(!p.hid||!n)return;const e=Date.now().toString(36)+Math.random().toString(36).slice(2,6);X(`households/${p.hid}/completed_items/${e}`,{name:n,completedAt:new Date().toISOString()}).catch(t=>console.warn("recordCompleted error:",t))}function kT(n){const e=p.shop.find(i=>i.id===n);if(!e)return;const t=!e.checked;Ve({...e,checked:t}),t&&Ef(e.name)}function CT(n,e){n.stopPropagation();const t=f("sne-"+e),i=f("sni-"+e);if(!t)return;t.classList.toggle("open")&&i&&(i.focus(),i.setSelectionRange(i.value.length,i.value.length))}function RT(n){const e=f("sni-"+n);if(!e)return;const t=p.shop.find(s=>s.id===n);if(!t)return;const i=e.value.trim();i!==(t.note||"")&&Ve({...t,note:i})}function PT(n){const e=f("sqe-"+n),t=f("sqi-"+n);if(!e)return;e.classList.toggle("open")&&t&&(t.focus(),t.select())}function xT(n,e){const t=f("sqi-"+n);if(!t)return;const i=Math.max(1,(parseInt(t.value,10)||1)+e);t.value=i,If(n)}function If(n){const e=f("sqi-"+n);if(!e)return;const t=p.shop.find(s=>s.id===n);if(!t)return;const i=Math.max(1,parseInt(e.value,10)||1);i!==(t.qty||1)&&Ve({...t,qty:i})}function LT(){p.aisleMode=!p.aisleMode;const n=f("aislebtn");n&&(n.style.background=p.aisleMode?"var(--ac)":"",n.style.color=p.aisleMode?"var(--bg)":""),si()}function DT(n){["list","deals"].forEach(i=>{const s=f("shtab-"+i);s&&s.classList.remove("active");const r=f("sh-"+i+"-body");r&&(r.style.display="none")});const e=f("shtab-"+n);e&&e.classList.add("active");const t=f("sh-"+n+"-body");t&&(t.style.display="block"),n==="deals"&&Sf()}function NT(){const n=p.shop.filter(i=>!i.checked);if(!n.length){P("List is empty!");return}const t=`🛒 Shopping List

`+n.map(i=>{let s="• "+i.name;return(i.qty||1)>1&&(s+=" × "+i.qty),i.price&&(s+=" (~$"+i.price+")"),s}).join(`
`);navigator.share?navigator.share({title:"Shopping List",text:t}).catch(()=>{}):navigator.clipboard&&navigator.clipboard.writeText(t).then(()=>P("List copied!"))}function MT(){const n=p.shop.filter(t=>t.checked);if(!n.length){P("No completed items!");return}const e=f("atk-body");e.innerHTML=`<div style="padding:16px">
  ...
  </div>`,wt("atk")}function OT(n,e,t){const i=f("atk-"+n);i.dataset.loc=e,i.querySelectorAll(".atk-loc button").forEach(s=>s.classList.remove("sel")),t.classList.add("sel")}async function VT(){const n=p.shop.filter(i=>i.checked),e=new Date().toLocaleDateString();let t=0;for(const i of n){const s=f("atk-"+i.id);if(!s)continue;const r=s.dataset.loc||La(i.name),a=p.inv.find(u=>u.name.toLowerCase()===i.name.toLowerCase()),c=i.qty||1;await ke({id:a?a.id:"inv-"+Date.now()+"-"+Math.random().toString(36).slice(2),name:a?a.name:i.name,qty:a?a.qty+c:c,unit:a?a.unit:"unit",location:r,category:a?a.category:Ht({name:i.name}),addedAt:a?a.addedAt:e,brand:a?a.brand:i.brand||"",expiry:a?a.expiry:null,image:a?a.image:i.image||null,source:"shopping"}),await Tr(i.id),t++}Ae("atk"),P(`${t} item${t!==1?"s":""} added to your kitchen! 🧺`)}async function $T(){const n=Zn().map(s=>{const r=s.toISOString().split("T")[0];return p.mp[r]?`${s.toLocaleDateString("en-US",{weekday:"short"})}: ${p.mp[r]}`:""}).filter(Boolean).join(", ");if(!n){P("No meals planned yet!");return}const e=p.inv.map(s=>`${s.name} (${s.qty} ${s.unit})`).join(", "),t=document.querySelector('[onclick="buildList()"]'),i=t?t.textContent:"";t&&(t.disabled=!0,t.textContent="⏳ Thinking…");try{const r=await(await fetch("/api/proxy",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-haiku-4-5-20251001",max_tokens:500,messages:[{role:"user",content:`Week meals: ${n}
Already have: ${e}
...
Recipe: ${e.description}`}]})})).json(),r=(s.content&&s.content[0]&&s.content[0].text||"").replace(/```json|```/g,"").trim(),c=JSON.parse(r).filter(u=>!t.some(d=>d.includes(u.toLowerCase())||u.toLowerCase().includes(d)));if(!c.length){P("All ingredients already in pantry ✓");return}for(const u of c)await Ve({id:"shop-"+Date.now()+"-"+Math.random().toString(36).slice(2),name:u,qty:1,checked:!1,src:"recipe"});P(`Added ${c.length} ingredient${c.length!==1?"s":""} to shopping list 🛒`),Ae("erec"),window.showScreen("shopping")}catch{P("Couldn't parse ingredients")}}function PE(n,e){p.nr=n,e==="r"?Mi("rstars",n):e==="c"?Mi("cstars",n):e==="e"&&Mi("estars",n)}async function xE(n){const e=p.recs.find(r=>r.id===n);if(!e)return;const t=!e.isPublic,i=De(),s=(i==null?void 0:i.displayName)||localStorage.getItem("ks-who")||"Anonymous";t?(await Vv(e,s,p.hid),P("Recipe shared with the community!")):(await $v(e.id),P("Recipe removed from community")),await Bt({...e,isPublic:t})}async function ac(){const n=f("rbody");if(n){n.innerHTML='<div class="es"><div class="ei">🌍</div><p>Loading community recipes…</p></div>';try{p.comRecs=await Fv(),cc()}catch(e){console.error("loadCommunity:",e),n.innerHTML=`<div class="es"><div class="ei">⚠️</div><p>Couldn't load community recipes.</p></div>`}}}function LE(n){p.comCuisine=n,cc()}function DE(n){p.comSearch=n,cc()}function cc(){const n=f("rbody");if(!n)return;let e=[...p.comRecs];if(p.comCuisine&&p.comCuisine!=="all"&&(e=e.filter(s=>(s.cuisine||"").toLowerCase().includes(p.comCuisine.toLowerCase())||(s.tags||[]).some(r=>r.toLowerCase().includes(p.comCuisine.toLowerCase())))),p.comSearch){const s=p.comSearch.toLowerCase();e=e.filter(r=>(r.title||"").toLowerCase().includes(s)||(r.tags||[]).join(" ").toLowerCase().includes(s)||(r.cuisine||"").toLowerCase().includes(s)||(r.authorName||"").toLowerCase().includes(s))}e.sort((s,r)=>new Date(r.createdAt||0)-new Date(s.createdAt||0));const t=f("rsub");t&&(t.textContent=e.length+" community recipe"+(e.length!==1?"s":""));let i=`<div style="margin-bottom:14px">
    ...
    </div>`,wt("erec")}async function ME(n){if(!De()){P("Sign in to like recipes");return}const t=p.myLikes.has(n);try{await Uv(n,t),t?p.myLikes.delete(n):p.myLikes.add(n);const i=p.comRecs.find(r=>r.id===n);i&&(i.likes=(i.likes||0)+(t?-1:1));const s=f("com-like-btn");if(s){const r=p.myLikes.has(n);s.className=`btn ${r?"bp":"bs"} bsm`,s.innerHTML=`${r?"❤️":"🤍"} ${(i==null?void 0:i.likes)||0} Like${((i==null?void 0:i.likes)||0)!==1?"s":""}`}P(t?"Like removed":"Liked!")}catch(i){console.error("likeComRecipe:",i),P("Couldn't update like")}}async function OE(n){if(!De()){P("Sign in to save recipes");return}const t=p.comRecs.find(i=>i.id===n);if(t)try{await qv(t),P("Recipe saved to your kitchen! 📖"),Ae("erec")}catch(i){console.error("saveComToKitchen:",i),P("Couldn't save recipe")}}async function VE(n){var r;const e=De();if(!e){P("Sign in to comment");return}const t=f("com-cmt-input"),i=(r=t==null?void 0:t.value)==null?void 0:r.trim();if(!i)return;const s=e.displayName||localStorage.getItem("ks-who")||"Anonymous";try{const a=await jv(n,i,s);t.value="";const c=f("com-comments");c&&a&&(c.querySelector("div[style*='color:var(--mt)']")&&!c.querySelector("div[style*='border-bottom']")&&(c.innerHTML=""),c.innerHTML+=`<div style="padding:10px 0;border-bottom:1px solid var(--b1)">
        <div style="display:flex;justify-content:space-between;align-items:center">
...
`+e.steps:""].join("").trim();await Bt({id:t,name:e.title||"Untitled Recipe",rating:0,favorited:!1,notes:"",description:i,source:"Claude Chat",sourceUrl:null,tags:[],cuisine:e.cuisine||"",cookTime:e.cookTime||"",servings:e.servings||"",cookCount:0,savedAt:new Date().toLocaleDateString(),isPublic:!1}),n.textContent="✓ Saved!",n.disabled=!0,n.style.background="var(--gn)",P("Recipe saved! 📖")}catch{P("Couldn't save recipe")}}function xo(n,e){const t=f("chmsgs");if(t){if(n==="assistant"){const{cleanText:i,recipes:s}=BE(e);if(i){const r=document.createElement("div");r.className="cb asst",r.innerHTML=jE(i),t.appendChild(r)}s.forEach(r=>{const a=document.createElement("div");a.style.maxWidth="88%",a.style.alignSelf="flex-start",a.innerHTML=HE(r),t.appendChild(a)})}else{const i=document.createElement("div");i.className="cb user",i.innerHTML=e,t.appendChild(i)}t.scrollTop=t.scrollHeight}}function zE(n){const e=f("chi");e&&(e.value=n.textContent),Rf()}function WE(){p.chat=[];const n=f("chmsgs");n&&(n.innerHTML='<div class="cb asst">Hey! 👋 I know your full inventory, meal plan, and saved recipes. What do you need?</div>')}function Pf(n){n.style.height="auto",n.style.height=Math.min(n.scrollHeight,120)+"px"}let Ki=!1,Ws=!1,Gs=null;function lc(){if(Ki)return;const n=f("scanner-video");if(!n)return;const e=f("scan-status");e&&(e.textContent="Starting camera…",e.style.display="block"),requestAnimationFrame(()=>{requestAnimationFrame(()=>{GE(n,e)})})}function GE(n,e){Quagga.init({inputStream:{name:"Live",type:"LiveStream",target:n,constraints:{facingMode:"environment",width:{ideal:1280},height:{ideal:720}}},locator:{patchSize:"medium",halfSample:!0},decoder:{readers:["ean_reader","ean_8_reader","upc_reader","upc_e_reader","code_128_reader","code_39_reader"]},locate:!0,frequency:10},function(t){if(t){console.error("Scanner init error:",t);const i=f("scerr");i&&(i.textContent="⚠️ Could not access camera. Try entering the barcode manually.",i.style.display="block"),e&&(e.style.display="none");return}KE(n),Quagga.start(),Ki=!0,e&&(e.textContent="Scanning…"),setTimeout(()=>QE(n),2e3)}),Quagga.onDetected(xf)}function KE(n){n.querySelectorAll("video").forEach(e=>{e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),e.muted=!0,e.play().catch(()=>{})})}async function QE(n){if(!Ki)return;const e=n.querySelector("video");if(!(!e||e.videoWidth>0)){console.warn("Camera feed appears black — retrying with manual getUserMedia");try{const t=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1280},height:{ideal:720}}});Gs=t,e.srcObject&&e.srcObject.getTracks().forEach(i=>i.stop()),e.srcObject=t,e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),e.muted=!0,await e.play()}catch(t){console.error("Manual camera retry failed:",t)}}}function uc(){if(Ki){try{Quagga.stop()}catch{}Quagga.offDetected(xf),Gs&&(Gs.getTracks().forEach(n=>n.stop()),Gs=null),Ki=!1,Ws=!1}}async function xf(n){var s,r;if(Ws)return;const e=n&&n.codeResult&&n.codeResult.code;if(!e)return;const t=((r=(s=n.codeResult.decodedCodes)==null?void 0:s.filter(a=>a.error!==void 0))==null?void 0:r.map(a=>a.error))||[];if(!((t.length?t.reduce((a,c)=>a+c,0)/t.length:1)>.25)){Ws=!0,JE(),uc(),f("scanbody").style.display="none",f("scspin").style.display="block",f("scst").textContent="Found "+e+" — looking up…";try{const a=await Lf(e);p.cp=a,f("aqty").value=1,f("aexp").value="",hc("fridge",f("rl-fridge")),Df(a)}catch{const a=f("scerr");a.textContent="⚠️ Lookup failed. Check your connection or enter the barcode manually.",a.style.display="block"}f("scanbody").style.display="block",f("scspin").style.display="none",Ws=!1}}function JE(){const n=f("scan-success");n&&(n.style.display="flex",n.style.animation="none",n.offsetHeight,n.style.animation="",setTimeout(()=>{n.style.display="none"},500))}function YE(){Ae("result"),wt("scan"),f("scerr").style.display="none",lc()}function XE(){p.scanDestList=!0,wt("scan");const n=f("scanovttl");n&&(n.textContent="Scan → Shopping List");const e=f("scan-dest-hint");e&&(e.textContent="Running low? Scan to add to your shopping list."),f("scerr").style.display="none",lc()}function ZE(){p.scanDestList=!1,wt("scan");const n=f("scanovttl");n&&(n.textContent="Scan Barcode");const e=f("scan-dest-hint");e&&(e.textContent="Scan a barcode to add to your pantry or shopping list."),f("scerr").style.display="none",lc()}function eI(){const n=f("scanNoteWrap");if(!n)return;const e=n.style.display==="none";if(n.style.display=e?"block":"none",e){const t=f("scanNoteInp");t&&t.focus()}}function tI(){if(!p.cp)return;const n=p.cp.notFound?"Barcode "+p.cp.barcode:p.cp.name,e=f("scanNoteInp"),t=e?e.value.trim():"",i=parseInt(f("aqty").value)||1,s={id:Date.now().toString(),name:n,qty:i,checked:!1,src:"scan"};p.cp.brand&&(s.brand=p.cp.brand),p.cp.image&&(s.image=p.cp.image),t&&(s.note=t),Ve(s),P("Added to list: "+n),Ae("result"),Ae("scan"),p.scanDestList=!1,e&&(e.value="");const r=f("scanNoteWrap");r&&(r.style.display="none"),window.showScreen("shopping")}function nI(){const n=f("mentry");n.style.display=n.style.display==="none"?"block":"none"}async function iI(){const n=f("meinp").value.trim();if(!n)return;uc(),f("scanbody").style.display="none",f("scspin").style.display="block",f("scst").textContent="Looking up…";const e=await Lf(n);p.cp=e,f("aqty").value=1,f("aexp").value="",hc("fridge",f("rl-fridge")),f("meinp").value="",Df(e),f("scanbody").style.display="block",f("scspin").style.display="none"}async function Lf(n){try{const e=await fetch("/api/barcode?code="+encodeURIComponent(n));if(e.ok){const t=await e.json();if(t.found&&t.product)return{...t.product,notFound:!1}}}catch{}return{barcode:n,name:"",brand:"",quantity:"",category:"General",image:null,source:null,description:"",notFound:!0}}function sI(n,e){switch(n){case"Open Food Facts":return`https://world.openfoodfacts.org/product/${e}`;case"Open Beauty Facts":return`https://world.openbeautyfacts.org/product/${e}`;case"Open Pet Food Facts":return`https://world.openpetfoodfacts.org/product/${e}`;case"UPC Item DB":return`https://www.upcitemdb.com/upc/${e}`;case"Edamam":return"https://www.edamam.com/food-database/en/";default:return"#"}}function Df(n){Ae("scan"),f("resttl").textContent=n.notFound?"Not Found":"Product Found ✓",f("aunit").value=n.quantity||"unit";let e="";if(n.notFound)e=`<div class="nfb">⚠️ Barcode <code>${n.barcode}</code> not found in any database. Enter name:<input class="fi" id="mnm" placeholder="Product name (required)" oninput="valAdd()" style="margin-top:10px"/></div>`,setTimeout(()=>f("addbtn").disabled=!0,0);else{const t=n.image?`<img src="${n.image}" class="pimg" onerror="this.style.display='none'"/>`:'<div class="pimg" style="display:flex;align-items:center;justify-content:center;font-size:1.8rem">🛒</div>';let i="";n.nutrition&&(n.nutrition.calories||n.nutrition.protein)&&(i=`<div class="ngrd">${[["Cal",n.nutrition.calories],["Protein",n.nutrition.protein],["Fat",n.nutrition.fat],["Carbs",n.nutrition.carbs]].map(([a,c])=>`<div class="nb"><div class="nv">${c||"—"}</div><div class="nl">${a}</div></div>`).join("")}</div>`);const s=n.description?`<div class="pdsc">${n.description}</div>`:"",r=n.source?`<a href="${sI(n.source,n.barcode)}" target="_blank" rel="noopener" class="srcb" style="text-decoration:none">${n.source} ↗</a>`:"";e=`<div class="pcard"><div class="phdr">${t}<div style="flex:1"><div class="pnm">${n.name}</div>${n.brand?`<div class="pbr">${n.brand}</div>`:""}<div class="pbc">${n.barcode}</div><span class="bdg">${n.category}</span>${r}</div></div>${s}${i}</div>`,setTimeout(()=>f("addbtn").disabled=!1,0)}f("resbody").innerHTML=e,wt("result")}function hc(n,e){p.selR=n,document.querySelectorAll("#ov-result .lbtn").forEach(t=>t.classList.remove("sel")),e&&e.classList.add("sel")}function rI(){const n=f("mnm");f("addbtn").disabled=!(n&&n.value.trim())}async function oI(){if(!p.cp)return;const n=f("mnm"),e=p.cp.notFound?n&&n.value.trim()||"":p.cp.name;if(!e)return;const t=f("aunit").value.trim()||"unit",i=Math.max(1,parseInt(f("aqty").value)||1),s=f("aexp").value||null,r="item-"+p.cp.barcode.replace(/\W/g,"-"),a=p.inv.find(c=>c.id===r);await ke({id:r,barcode:p.cp.barcode,name:e,brand:p.cp.brand||"",unit:t,qty:a?a.qty+i:i,location:p.selR,category:p.cp.category||"General",image:p.cp.image||null,source:p.cp.source||null,nutrition:p.cp.nutrition||null,expiry:s,addedAt:a?a.addedAt:new Date().toLocaleDateString()}),P(a?`+${i} added to ${e}`:`${e} added!`),p.cp=null,Ae("result")}function aI(n){const e=f("aqty");e.value=Math.max(1,(parseInt(e.value)||1)+n)}let In=null,Ku=0,We=null;function cI(){document.addEventListener("touchstart",n=>{const e=n.target.closest(".swipe-inner");!e||!e.closest(".swipe-wrap")||p.selectMode||(In=e,Ku=n.touches[0].clientX,e.classList.add("swiping"))},{passive:!0}),document.addEventListener("touchmove",n=>{if(!In)return;const e=n.touches[0].clientX-Ku,t=Math.max(-80,Math.min(0,e));In.style.transform=`translateX(${t}px)`,Math.abs(e)>8&&n.preventDefault()},{passive:!1}),document.addEventListener("touchend",()=>{if(!In)return;const n=In,e=n.closest(".swipe-wrap");n.classList.remove("swiping"),(parseFloat(n.style.transform.replace("translateX(",""))||0)<-50?(n.style.transform="translateX(-80px)",e==null||e.classList.add("open"),We&&We!==e&&fa(We),We=e):(n.style.transform="translateX(0)",e==null||e.classList.remove("open"),We===e&&(We=null)),In=null}),document.addEventListener("touchstart",n=>{if(!We||n.target.closest(".swipe-del"))return;const e=n.target.closest(".swipe-inner");e&&e.closest(".swipe-wrap")===We||(fa(We),We=null)},{passive:!0})}function fa(n){const e=n==null?void 0:n.querySelector(".swipe-inner");e&&(e.style.transform="translateX(0)"),n==null||n.classList.remove("open")}async function lI(n,e){const t=f("sw-"+n);t&&(t.style.opacity="0.5"),e==="shop"?await Tr(n):(await Ca(n),P("Item removed"))}function uI(n,e){const t=f("sw-"+n);if(t){const i=t.querySelector(".swipe-inner");if((parseFloat((i.style.transform||"").replace("translateX(",""))||0)<-10){fa(t),We=null;return}}if(p.selectMode){p.selectedIds.has(n)?(p.selectedIds.delete(n),t==null||t.classList.remove("selected")):(p.selectedIds.add(n),t==null||t.classList.add("selected")),Fr();return}e==="shop"?window.togShop(n):window.openAdj(n)}function hI(){if(p.selectMode==="shop"){Wn();return}p.selectMode&&Wn(),p.selectMode="shop",p.selectedIds.clear(),document.querySelectorAll("#shlist .swipe-wrap").forEach(e=>e.classList.add("selecting"));const n=f("sh-selbtn");n&&(n.classList.add("active"),n.textContent="Cancel"),Fr()}function dI(){if(p.selectMode==="inv"){Wn();return}p.selectMode&&Wn(),p.selectMode="inv",p.selectedIds.clear(),document.querySelectorAll("#ibody .swipe-wrap").forEach(e=>e.classList.add("selecting"));const n=f("inv-selbtn");n&&(n.classList.add("active"),n.textContent="Cancel"),Fr()}function Wn(){p.selectMode=null,p.selectedIds.clear(),document.querySelectorAll(".swipe-wrap.selecting").forEach(t=>t.classList.remove("selecting","selected"));const n=f("sh-selbtn");n&&(n.classList.remove("active"),n.textContent="Select");const e=f("inv-selbtn");e&&(e.classList.remove("active"),e.textContent="Select"),Fr()}async function fI(){if(!p.selectedIds.size)return;const n=[...p.selectedIds],e=p.selectMode;Wn(),e==="shop"?await Promise.all(n.map(t=>Tr(t))):await Promise.all(n.map(t=>Ca(t))),P(`Removed ${n.length} item${n.length!==1?"s":""} 🗑`)}function Fr(){const n=f("multi-bar");if(!n)return;const e=p.selectedIds.size,t=f("multi-count");t&&(t.textContent=e),p.selectMode?n.classList.add("visible"):n.classList.remove("visible")}const pI=["Chicken","Beef","Fish","Vegetarian","Vegan","Quick","Kids","Healthy","Batch Cook","Date Night"];function Nf(n){return"chip-"+n.split(" ").join("-")}function Mf(){const n=f("recChips");n&&(n.innerHTML=pI.map(e=>`<button onclick="toggleChip('${e}')" id="${Nf(e)}" style="padding:5px 10px;border-radius:20px;border:1px solid var(--bd);background:var(--s2);color:var(--tx2);font-size:.78rem;cursor:pointer;transition:all .15s">${e}</button>`).join(""))}function mI(n){const e=f(Nf(n));window._activeChips.has(n)?(window._activeChips.delete(n),e&&(e.style.background="var(--s2)",e.style.color="var(--tx2)",e.style.borderColor="var(--bd)")):(window._activeChips.add(n),e&&(e.style.background="var(--ac)",e.style.color="#000",e.style.borderColor="var(--ac)")),Of()}function Of(){const n=f("recPicker"),e=f("recFilter")?f("recFilter").value.trim().toLowerCase():"",t=[...window._activeChips].map(r=>r.toLowerCase()),s=[...p.recs].sort((r,a)=>(a.cookCount||0)-(r.cookCount||0)).filter(r=>{const a=(r.name+" "+(r.description||"")+" "+(r.tags||[]).join(" ")).toLowerCase(),c=e?e.split(/\s+/).every(d=>a.includes(d)):!0,u=t.every(d=>a.includes(d));return c&&u});n.innerHTML='<option value="">— pick a saved recipe —</option>'+s.map(r=>`<option value="${r.id}">${r.name}</option>`).join(""),window._pickedRec=null,f("mealMinp").value=""}function gI(n,e){p.md=n,f("mealMttl").textContent="Meal for "+e,f("mealMinp").value=p.mp[n]||"",window._pickedRec=null,window._activeChips=new Set;const t=f("recFilter");t&&(t.value=""),Mf();const i=f("recPicker");if(p.recs&&p.recs.length){const s=[...p.recs].sort((c,u)=>(u.cookCount||0)-(c.cookCount||0));i.innerHTML='<option value="">— pick a saved recipe —</option>'+s.map(c=>`<option value="${c.id}">${c.name}</option>`).join("");const r=p.mp[n]||"",a=s.find(c=>c.name===r);i.value=a?a.id:"",f("recPickerWrap").style.display="block"}else f("recPickerWrap").style.display="none";f("mealM").classList.add("active"),setTimeout(()=>f("mealMinp").focus(),100)}function yI(n){if(!n){window._pickedRec=null,f("mealMinp").value="";return}const e=p.recs.find(t=>t.id===n);e&&(window._pickedRec=e,f("mealMinp").value=e.name)}function dc(){f("mealM").classList.remove("active")}async function vI(){const n=f("mealMinp").value.trim();if(await gn(p.md,n||null),window._pickedRec&&window._pickedRec.description){const e=window._pickedRec.description,t=p.inv.map(a=>a.name.toLowerCase()),i=p.shop.map(a=>a.name.toLowerCase()),s=e.split(/[\n,]/).map(a=>a.replace(/^[\d\/\s]*(cup|tbsp|tsp|oz|lb|g|kg|ml|l|clove|slice|piece|bunch|head|can|package|pkg)s?\.?\s*/gi,"").replace(/^[\d]+\s*/,"").trim()).filter(a=>a.length>1&&a.length<60);let r=0;for(const a of s){if(/\b(add|mix|heat|cook|bake|stir|boil|fry|slice|chop|dice|combine|place|pour|season|serve|preheat|bring|remove|let|set|transfer)\b/i.test(a))continue;const c=a.replace(/^[-•*]\s*/,"").trim();if(!c||c.length<2)continue;const u=c.toLowerCase();t.some(d=>d.includes(u)||u.includes(d))||i.some(d=>d===u)||(await Ve({id:Date.now().toString()+Math.random().toString(36).slice(2),name:c,qty:1,checked:!1,src:"recipe"}),r++)}r>0&&P(`Added ${r} ingredient${r!==1?"s":""} to shopping list 🛒`)}window._pickedRec=null,dc(),_n(),as(),ii()}async function wI(){await gn(p.md,null),dc(),_n(),as(),ii()}function _I(n){const e=p.mp[n];e&&(p.cn=e,p.nr=0,f("cookedNm").textContent=e,f("cnotes").value="",Mi("cstars",0),f("cookedM").classList.add("active"))}async function bI(){await ad(p.cn,xt()),await gn(xt(),null),f("cookedM").classList.remove("active"),_n(),ii(),P("Meal logged!")}async function TI(){var i;const n=f("cnotes").value.trim(),e=(i=f("tog-leftover"))==null?void 0:i.classList.contains("on");await ad(p.cn,xt());const t=p.recs.find(s=>s.name.toLowerCase()===p.cn.toLowerCase());t?await Bt({...t,cookCount:(t.cookCount||0)+1,lastCooked:xt()}):await Bt({id:"rec-"+Date.now(),name:p.cn,rating:p.nr,favorited:!1,notes:n,description:"",source:"Meal Plan",tags:[],cookCount:1,savedAt:new Date().toLocaleDateString(),lastCooked:xt()}),e&&await gn(Gv(),p.cn+" (leftovers)"),await gn(xt(),null),f("cookedM").classList.remove("active"),_n(),ii(),P(e?"Saved! Leftovers planned for tomorrow 🥡":"Saved to recipes! ⭐")}function EI(n){f("schedNm").textContent=n;const e=["S","M","T","W","T","F","S"],t=new Date;t.setHours(0,0,0,0),f("schedWk").innerHTML=Zn().map((i,s)=>{const r=i.toISOString().split("T")[0],a=i.getTime()===t.getTime(),c=p.mp[r];return`<div class="wd${a?" today":""}${c?" hm":""}" onclick="schedSet('${r}','${n}')"><div class="wdn">${e[s]}</div><div class="wdd">${i.getDate()}</div>${c?`<div class="wdm">${c.substring(0,8)}…</div>`:""}</div>`}).join(""),f("schedM").classList.add("active")}async function II(n,e){await gn(n,e),f("schedM").classList.remove("active"),_n(),ii(),P("Scheduled! 📅")}function SI(){const n=s=>f(s),e=(s,r)=>{const a=n(s);a&&(a.value=r||"")};e("setName",p.cfg.name),e("setAdults",p.cfg.adults),e("setKids",p.cfg.kids),e("setOther",p.cfg.other),e("setCuisines",p.cfg.cuisines),e("setCookTime",p.cfg.cookTime),e("setZipcode",p.cfg.zipcode);const t=(s,r)=>{const a=n(s);a&&a.classList.toggle("on",!!r)};t("tg-nopork",p.cfg.nopork),t("tg-noshellfish",p.cfg.noshellfish),t("tg-vegetarian",p.cfg.vegetarian),t("tg-glutenfree",p.cfg.glutenfree),t("tg-notif",p.cfg.notif);const i=f("notifTimeRow");i&&(i.style.display=p.cfg.notif?"block":"none"),e("setNotifTime",p.cfg.notifTime||"8"),e("setNotifDays",String(p.cfg.notifDays||3)),pc(),$f()}async function AI(){p.cfg={...p.cfg,name:f("setName").value.trim(),adults:f("setAdults").value.trim(),kids:f("setKids").value.trim(),nopork:f("tg-nopork").classList.contains("on"),noshellfish:f("tg-noshellfish").classList.contains("on"),vegetarian:f("tg-vegetarian").classList.contains("on"),glutenfree:f("tg-glutenfree").classList.contains("on"),other:f("setOther").value.trim(),cuisines:f("setCuisines").value.trim(),cookTime:f("setCookTime").value,zipcode:f("setZipcode")?f("setZipcode").value.trim():"",notif:f("tg-notif").classList.contains("on"),notifTime:f("setNotifTime")?f("setNotifTime").value:"8",notifDays:parseInt(f("setNotifDays")?f("setNotifDays").value:"3")},await br(),p.cfg.notif&&Vf(),P("Settings saved!"),Ae("settings"),tc()}async function kI(){var e,t;const n=((t=(e=f("setZipcode"))==null?void 0:e.value)==null?void 0:t.trim())||"";p.cfg={...p.cfg,zipcode:n},await br(),P("Saved!")}async function CI(n){if(!n.classList.contains("on")){if(!("Notification"in window)){P("Notifications not supported on this browser");return}if(Notification.permission==="denied"){P("Notifications blocked — enable in browser settings");return}if(Notification.permission!=="granted"&&await Notification.requestPermission()!=="granted"){P("Notifications permission denied");return}}n.classList.toggle("on");const t=f("notifTimeRow");t&&(t.style.display=n.classList.contains("on")?"block":"none")}function RI(){if(Notification.permission!=="granted"){P("Enable notifications first");return}const n=p.inv.filter(t=>{const i=rt(t.expiry);return i&&(i.c==="expiring"||i.c==="expired")});if(!n.length){new Notification("Kitchen 🧺",{body:"No items expiring soon — you're all good!"});return}const e=n.slice(0,3).map(t=>t.name).join(", ");new Notification("Kitchen 🧺 — Expiring Soon",{body:`${e}${n.length>3?" + "+(n.length-3)+" more":""} need attention`})}function Vf(){if(!p.cfg.notif||Notification.permission!=="granted")return;const n=parseInt(localStorage.getItem("ks-lastnotif")||"0"),e=Date.now();if(e-n<864e5)return;localStorage.setItem("ks-lastnotif",e.toString());const t=p.cfg.notifDays||3,i=p.inv.filter(r=>{if(!rt(r.expiry))return!1;const c=new Date(r.expiry+"T00:00:00"),u=new Date;return u.setHours(0,0,0,0),Math.round((c-u)/864e5)<=t});if(!i.length)return;const s=i.slice(0,3).map(r=>r.name).join(", ");new Notification("Kitchen 🧺 — Expiring Soon",{body:`${s}${i.length>3?" + "+(i.length-3)+" more":""} expiring in ${t} days or less`})}function fc(){return xe("ks-hhs")||[p.hid]}async function $f(){const n=De();if(n)try{const e=await fe(`households/${p.hid}`);if(!e)return;const t=e.ownerUid===n.uid,i=f("hhInviteCode");if(i&&(i.textContent=e.inviteCode||"—"),e.inviteCode&&t)try{await X(`household_codes/${e.inviteCode}`,{householdId:p.hid})}catch{}const s=f("regenCodeBtn");s&&(s.style.display=t?"":"none");const r=f("hhMembers");r&&e.members&&(r.innerHTML=e.members.map(a=>{const c=a.uid===n.uid,u=a.role==="owner"?"Owner":"Member",d=t&&!c?`<button onclick="event.stopPropagation();removeMemberFromHH('${a.uid}')" style="background:none;border:none;color:var(--rd);cursor:pointer;font-size:.78rem;padding:4px 8px">Remove</button>`:"";return`<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 12px;background:var(--card);border:1px solid var(--b2);border-radius:10px;margin-bottom:6px">
          ...
          ${d}
        </div>`}).join(""))}catch(e){console.error("renderHouseholdInfo error:",e)}}async function PI(){var e;const n=(e=f("hhInviteCode"))==null?void 0:e.textContent;if(!(!n||n==="—"))try{await navigator.clipboard.writeText(n),P("Invite code copied!")}catch{P("Couldn't copy — try manually")}}async function xI(){var t;const n=(t=f("hhInviteCode"))==null?void 0:t.textContent;if(!n||n==="—")return;const e=`Join my kitchen on Kitchen app! Use invite code: ${n} at https://pantry-app-zeta-six.vercel.app`;if(navigator.share)try{await navigator.share({text:e})}catch{}else try{await navigator.clipboard.writeText(e),P("Share text copied to clipboard!")}catch{P("Couldn't share — try manually")}}async function LI(){if(confirm("Regenerate invite code? The old code will stop working."))try{const n=await xv(p.hid);if(n){const e=f("hhInviteCode");e&&(e.textContent=n),P("New invite code generated!")}}catch(n){console.error("regenInviteCode error:",n),P("Failed to regenerate code")}}async function DI(n){if(confirm("Remove this member from the household?"))try{await Lv(p.hid,n),P("Member removed"),$f()}catch(e){console.error("removeMemberFromHH error:",e),P("Failed to remove member")}}async function NI(){var i,s,r;const n=(r=(s=(i=f("newHHCode"))==null?void 0:i.value)==null?void 0:s.trim())==null?void 0:r.toUpperCase();if(!n)return;const e=De();if(!e){P("Sign in first");return}const t=f("newHHCode");t.disabled=!0;try{const a=await od(n,e);if(!a){P("Invalid invite code. Check and try again."),t.disabled=!1;return}const c=fc();c.includes(a)||c.push(a),tt("ks-hhs",c),f("newHHCode").value="",pc(),P("Household joined!")}catch(a){console.error("addHousehold error:",a),P("Failed to join household")}t.disabled=!1}function MI(n){n!==p.hid&&(localStorage.setItem("ks-h",n),location.reload())}async function OI(n){if(n===p.hid){P("Can't remove active household");return}const e=De();if(e)try{const i=await fe(`users/${e.uid}`);if(i){const r=(i.householdIds||[]).filter(a=>a!==n);await X(`users/${e.uid}`,{...i,householdIds:r,id:void 0})}const s=await fe(`households/${n}`);if(s){const r=(s.members||[]).filter(c=>c.uid!==e.uid),a=(s.memberUids||[]).filter(c=>c!==e.uid);await X(`households/${n}`,{...s,members:r,memberUids:a,id:void 0})}}catch(i){console.error("removeHousehold error:",i)}const t=fc().filter(i=>i!==n);tt("ks-hhs",t),pc()}async function pc(){const n=fc().filter(i=>i!==p.hid),e=f("hhList");if(!e)return;if(!n.length){e.innerHTML='<div style="font-size:.82rem;color:var(--mt);padding:10px 0">No other households yet.</div>';return}const t=[];for(const i of n){let s=i;try{const r=await fe(`households/${i}`);r!=null&&r.name&&(s=r.name)}catch{}t.push({id:i,name:s})}e.innerHTML=t.map(({id:i,name:s})=>`<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 12px;background:var(--card);border:1px solid var(--b2);border-radius:10px;margin-bottom:6px;cursor:pointer" onclick="switchHousehold('${i}')">
      <div>
      ...
      </div>`)}async function qI(){var n,e,t,i,s,r,a,c,u,d,m,_,I;if(Pt===1){const R=(e=(n=f("ob-name"))==null?void 0:n.value)==null?void 0:e.trim(),N=(i=(t=f("ob-adults"))==null?void 0:t.value)==null?void 0:i.trim(),$=(r=(s=f("ob-kids"))==null?void 0:s.value)==null?void 0:r.trim(),M=(c=(a=f("ob-cuisines"))==null?void 0:a.value)==null?void 0:c.trim(),W=(u=f("ob-cooktime"))==null?void 0:u.value;R&&(p.cfg.name=R),N&&(p.cfg.adults=N),$&&(p.cfg.kids=$),M&&(p.cfg.cuisines=M),W&&(p.cfg.cookTime=W),p.cfg.nopork=((d=f("ob-nopork"))==null?void 0:d.checked)||!1,p.cfg.noshellfish=((m=f("ob-noshellfish"))==null?void 0:m.checked)||!1,p.cfg.vegetarian=((_=f("ob-vegetarian"))==null?void 0:_.checked)||!1,p.cfg.glutenfree=((I=f("ob-glutenfree"))==null?void 0:I.checked)||!1,await br()}Pt++,jf()}async function Bf(){const n=f("ov-onboarding");n&&n.classList.remove("active");const e=De();if(e)try{const t=await fe(`users/${e.uid}`);t&&await X(`users/${e.uid}`,{...t,onboardingDone:!0,id:void 0})}catch{}}async function zI(){await Bf(),P("You can always adjust settings later ⚙️")}window.getIdToken=id;O.renderAll=nc;O.renderSum=as;O.renderRecs=$r;O.renderShop=si;oT(Or);window.showScreen=function(n){var e,t;document.querySelectorAll(".ov.active").forEach(i=>i.classList.remove("active")),document.querySelectorAll(".screen").forEach(i=>i.classList.remove("active")),document.querySelectorAll(".ni").forEach(i=>i.classList.remove("active")),(e=f("screen-"+n))==null||e.classList.add("active"),(t=f("nav-"+n))==null||t.classList.add("active"),n==="home"&&vf(),n==="inventory"&&Or(),n==="recipes"&&(p.rt==="community"?ac():$r()),n==="shopping"&&si(),n==="insights"&&FE()};const WI=wt;window.showOv=function(n){WI(n),n==="settings"&&setTimeout(FI,80)};window.hideOv=Ae;window.initHome=tc;window.addLowToShop=uT;window.toggleExp=function(){const n=f("exppanel");n.style.display=n.style.display==="none"?"block":"none"};window.openAdj=qT;window.updL=zT;window.adjQ=WT;window.adjQD=GT;window.adjE=KT;window.adjNote=QT;window.setIT=XT;window.addManual=ZT;window.valMA=eE;window.chgMQ=tE;window.selML=nE;window.remItem=rc;window.importDoc=iE;window.adjLowThresh=JT;window.adjLowThreshD=YT;window.openInvAddSheet=oE;window.closeInvAddSheet=ls;window.invAddScan=aE;window.invAddVoice=cE;window.setInvAddLoc=lE;window.toggleInvAddNote=uE;window.qaddInv=hE;window.onInvInput=dE;window.pickInvInlineResult=pE;window.toggleInvVoice=kf;window.qadd=pT;window.togShop=kT;window.toggleShNote=CT;window.saveShNote=RT;window.openShQty=PT;window.adjShQty=xT;window.saveShQty=If;window.togAisle=LT;window.setSHT=DT;window.shareList=NT;window.openAddToKitchen=MT;window.setAtkLoc=OT;window.confirmAddToKitchen=VT;window.buildList=$T;window.toggleVoice=_f;window.toggleAddNote=mT;window.openShopAddSheet=gT;window.closeShopAddSheet=cs;window.shopAddScan=yT;window.shopAddVoice=vT;window.closeEnrichSheet=hr;window.pickEnrichResult=AT;window.onShopInput=bT;window.pickInlineResult=ET;window.openItemDetail=IT;window.closeItemDetail=ST;window.bpTog=FT;window.bpSelAll=UT;window.bpUpdBtn=function(){};window.bpConfirm=jT;window._bpItems=[];window.searchDeals=BT;window.dealsFromList=HT;window.addDealToList=Af;window.renderDealsZipBanner=Sf;window.clrChk=function(){p.shop.filter(n=>n.checked).forEach(n=>{Ef(n.name),Tr(n.id)})};window.setRT=wE;window.togFav=_E;window.valR=bE;window.importFromUrl=TE;window.saveRec=EE;window.openER=IE;window.updR=SE;window.delER=AE;window.scaleRec=kE;window.whatCanIMake=CE;window.addRecIngToShop=RE;window.setStar=PE;window.togTag=yE;window.togglePublic=xE;window.loadCommunity=ac;window.setComCuisine=LE;window.setComSearch=DE;window.openComRecipe=NE;window.likeComRecipe=ME;window.saveComToKitchen=OE;window.addComComment=VE;window.shareComRecipe=$E;window.sendChat=Rf;window.sendPill=zE;window.clrChat=WE;window.ar=Pf;window.importChatRecipe=qE;window.stopLiveScanner=uc;window.resumeScanner=YE;window.openScanForList=XE;window.openScanForInventory=ZE;window.addScannedToList=tI;window.toggleScanNote=eI;window.togManual=nI;window.manLookup=iI;window.selRL=hc;window.valAdd=rI;window.addToInv=oI;window.chgAQ=aI;window.swipeDelItem=lI;window.swipeRowTap=uI;window.togShopSelect=hI;window.togInvSelect=dI;window.cancelSelect=Wn;window.deleteSelected=fI;window.openMealM=gI;window.pickRec=yI;window.closeMealM=dc;window.saveMeal=vI;window.clrMeal=wI;window.openCooked=_I;window.skipCooked=bI;window.saveCooked=TI;window.scheduleRecipe=EI;window.schedSet=II;window.initRecChips=Mf;window.toggleChip=mI;window.filterRecs=Of;window._pickedRec=null;window._activeChips=new Set;window.saveSettings=AI;window.saveZipcode=kI;window.toggleNotif=CI;window.testNotif=RI;window.addHousehold=NI;window.switchHousehold=MI;window.removeHousehold=OI;window.setMode=VI;window.showNotif=P;window.copyInviteCode=PI;window.shareInviteCode=xI;window.regenInviteCode=LI;window.removeMemberFromHH=DI;window.enrichExistingItems=UI;window.manualRefresh=async function(n){const e=event==null?void 0:event.target;e&&(e.classList.add("spinning"),setTimeout(()=>e.classList.remove("spinning"),600)),ae("syncing");try{(n==="shop"||n==="both")&&(p.shop=await Le(`households/${p.hid}/shopping`),si()),(n==="inv"||n==="both")&&(p.inv=await Le(`households/${p.hid}/inventory`),Or(),nc()),ae("synced"),P("Refreshed ✓")}catch(t){console.error("manualRefresh error:",t),ae("error"),P("Refresh failed")}};window.onboardNext=qI;window.finishOnboarding=Bf;window.skipOnboarding=zI;window._appStart=async function(n){var t;p.hid=n,f("LS").style.display="none",f("APP").style.display="flex",window.showScreen("home"),ae("syncing");const e=De();if(e)try{const i=await fe(`users/${e.uid}`);if((t=i==null?void 0:i.householdIds)!=null&&t.length){const s=[...i.householdIds];s.includes(n)||s.push(n),tt("ks-hhs",s)}else{const s=xe("ks-hhs")||[n];s.includes(n)||(s.push(n),tt("ks-hhs",s))}}catch{const i=xe("ks-hhs")||[n];i.includes(n)||(i.push(n),tt("ks-hhs",i))}else{const i=xe("ks-hhs")||[n];i.includes(n)||(i.push(n),tt("ks-hhs",i))}await Mv(),SI(),tc(),fT(),mE(),rT(p.hid);try{ae("syncing");const i=await Promise.allSettled([Le(`households/${p.hid}/inventory`),Le(`households/${p.hid}/recipes`),Le(`households/${p.hid}/shopping`)]),s=(r,a)=>r.status==="fulfilled"?r.value:a;p.inv=s(i[0],p.inv),p.recs=s(i[1],p.recs),p.shop=s(i[2],p.shop),ae("synced"),nc(),$r(),si(),as()}catch(i){console.error("initial load error",i),ae("error")}setTimeout(BI,500)};$I();cI();p.cfg.notif&&setTimeout(Vf,3e3);si();function Ur(n){f("auth-loading").style.display="none",f("auth-signin").style.display=n==="signin"?"flex":"none",f("auth-signup").style.display=n==="signup"?"flex":"none",f("auth-join").style.display=n==="join"?"flex":"none",f("authError").style.display="none",f("signupError").style.display="none"}function Ke(n,e){const t=f(n);t&&(t.textContent=e,t.style.display="block")}function jr(n){return{"auth/invalid-email":"Please enter a valid email address.","auth/user-disabled":"This account has been disabled.","auth/user-not-found":"No account found with this email.","auth/wrong-password":"Incorrect password.","auth/invalid-credential":"Incorrect email or password.","auth/email-already-in-use":"An account with this email already exists.","auth/weak-password":"Password must be at least 6 characters.","auth/too-many-requests":"Too many attempts. Please try again later.","auth/popup-closed-by-user":"Sign-in popup was closed.","auth/cancelled-popup-request":"Sign-in was cancelled.","auth/account-exists-with-different-credential":"An account already exists with this email using a different sign-in method."}[n.code]||n.message||"Something went wrong. Please try again."}function Fe(n,e){n&&(e?(n._origText=n.textContent,n.textContent="Please wait…",n.disabled=!0):(n.textContent=n._origText||n.textContent,n.disabled=!1))}var Ju;(Ju=f("btnGoogle"))==null||Ju.addEventListener("click",async()=>{const n=f("btnGoogle");Fe(n,!0),f("authError").style.display="none";try{await Sv()}catch(e){Ke("authError",jr(e))}Fe(n,!1)});var Yu;(Yu=f("btnApple"))==null||Yu.addEventListener("click",async()=>{const n=f("btnApple");Fe(n,!0),f("authError").style.display="none";try{await Av()}catch(e){Ke("authError",jr(e))}Fe(n,!1)});var Xu;(Xu=f("btnEmailSign"))==null||Xu.addEventListener("click",async()=>{var i,s,r;const n=(s=(i=f("authEmail"))==null?void 0:i.value)==null?void 0:s.trim(),e=(r=f("authPass"))==null?void 0:r.value;if(!n||!e){Ke("authError","Please enter your email and password.");return}const t=f("btnEmailSign");Fe(t,!0),f("authError").style.display="none";try{await kv(n,e)}catch(a){Ke("authError",jr(a))}Fe(t,!1)});var Zu;(Zu=f("btnEmailSignup"))==null||Zu.addEventListener("click",async()=>{var s,r,a,c,u;const n=(r=(s=f("signupName"))==null?void 0:s.value)==null?void 0:r.trim(),e=(c=(a=f("signupEmail"))==null?void 0:a.value)==null?void 0:c.trim(),t=(u=f("signupPass"))==null?void 0:u.value;if(!n){Ke("signupError","Please enter your name.");return}if(!e||!t){Ke("signupError","Please enter your email and password.");return}const i=f("btnEmailSignup");Fe(i,!0),f("signupError").style.display="none";try{await Cv(e,t,n)}catch(d){Ke("signupError",jr(d))}Fe(i,!1)});var eh;(eh=f("btnToggleSignup"))==null||eh.addEventListener("click",()=>Ur("signup"));var th;(th=f("btnToggleSignin"))==null||th.addEventListener("click",()=>Ur("signin"));var nh;(nh=f("authPass"))==null||nh.addEventListener("keydown",n=>{var e;n.key==="Enter"&&((e=f("btnEmailSign"))==null||e.click())});var ih;(ih=f("signupPass"))==null||ih.addEventListener("keydown",n=>{var e;n.key==="Enter"&&((e=f("btnEmailSignup"))==null||e.click())});window.doSignOut=async function(){confirm("Sign out of Kitchen?")&&await Rv()};let Lo=!1;function pr(n){localStorage.setItem("ks-h",n),f("LS").style.display="none",f("APP").style.display="flex",window._appStart(n)}function GI(n){Ur("join"),f("btnCreateKitchen").onclick=async()=>{var e;Fe(f("btnCreateKitchen"),!0);try{const t=((e=p.cfg)==null?void 0:e.name)||"My Kitchen";await rd(n.uid,t);const i=await Bo(n);i.householdIds=[n.uid],await X(`users/${n.uid}`,i),localStorage.removeItem("ks-h");const s=xe("ks-hhs");if(s){const r=s.filter(a=>a!==n.uid);r.push(n.uid),localStorage.setItem("ks-hhs",JSON.stringify(r))}pr(n.uid)}catch(t){console.error("Create kitchen error:",t),Ke("joinError","Something went wrong. Please try again."),Fe(f("btnCreateKitchen"),!1)}},f("btnJoinKitchen").onclick=async()=>{var t,i,s;const e=(s=(i=(t=f("joinCode"))==null?void 0:t.value)==null?void 0:i.trim())==null?void 0:s.toUpperCase();if(!e){Ke("joinError","Please enter an invite code.");return}Fe(f("btnJoinKitchen"),!0),f("joinError").style.display="none";try{let r=await fe(`users/${n.uid}`);r||(r=await Bo(n));const a=await od(e,n);if(!a){Ke("joinError","Invalid invite code. Check and try again."),Fe(f("btnJoinKitchen"),!1);return}const c=xe("ks-hhs")||[];c.includes(a)||c.push(a),tt("ks-hhs",c),pr(a)}catch(r){console.error("Join kitchen error:",r),Ke("joinError","Something went wrong. Please try again."),Fe(f("btnJoinKitchen"),!1)}}}Ev(async n=>{var e;if(n){if(localStorage.setItem("ks-who",n.displayName||((e=n.email)==null?void 0:e.split("@")[0])||"You"),!Lo){Lo=!0;try{const t=await fe(`users/${n.uid}`),i=localStorage.getItem("ks-h"),s=xe("ks-hhs");if(!!t||!!i||s&&s.length>0){f("LS").style.display="none",f("APP").style.display="flex";const a=await Dv(n);pr(a)}else GI(n)}catch(t){console.error("Failed to resolve household:",t);const i=n.uid;pr(i)}}}else yf(),Lo=!1,f("APP").style.display="none",f("LS").style.display="flex",Ur("signin")});
