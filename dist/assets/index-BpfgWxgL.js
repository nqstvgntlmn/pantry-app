 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr=()=>sr().__FIREBASE_DEFAULTS__,or=()=>{if(typeof process>"u"||typeof jn>"u")return;const t=jn.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},ar=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&$i(t[1]);return e&&JSON.parse(e)},mn=()=>{try{return er()||rr()||or()||ar()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},cr=t=>{var e,n;return(n=(e=mn())==null?void 0:e.emulatorHosts)==null?void 0:n[t]},Pi=()=>{var t;return(t=mn())==null?void 0:t.config},Di=t=>{var e;return(e=mn())==null?void 0:e[`_${t}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Kr(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function Kr(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const tn="@firebase/app",Gn="0.14.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ne=new Ni("@firebase/app"),Jr="@firebase/app-compat",Yr="@firebase/analytics-compat",Qr="@firebase/analytics",Xr="@firebase/app-check-compat",Zr="@firebase/app-check",eo="@firebase/auth",to="@firebase/auth-compat",no="@firebase/database",io="@firebase/data-connect",so="@firebase/database-compat",ro="@firebase/functions",oo="@firebase/functions-compat",ao="@firebase/installations",co="@firebase/installations-compat",lo="@firebase/messaging",uo="@firebase/messaging-compat",ho="@firebase/performance",fo="@firebase/performance-compat",po="@firebase/remote-config",mo="@firebase/remote-config-compat",go="@firebase/storage",yo="@firebase/storage-compat",vo="@firebase/firestore",wo="@firebase/ai",bo="@firebase/firestore-compat",Io="firebase",ko="12.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const st=ko;function Hi(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i={name:nn,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw pe.create("bad-app-name",{appName:String(s)});if(n||(n=Pi()),!n)throw pe.create("no-options");const r=bt.get(s);if(r){if(Re(n,r.options)&&Re(i,r.config))return r;throw pe.create("duplicate-app",{appName:s})}const o=new Rr(s);for(const d of sn.values())o.addComponent(d);const l=new Co(n,i,o);return bt.set(s,l),l}function To(t=nn){const e=bt.get(t);if(!e&&t===nn&&Pi())return Hi();if(!e)throw pe.create("no-app",{appName:t});return e}function Te(t,e,n){let i=_o[t]??t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ne.warn(o.join(" "));return}Ye(new $e(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xo="firebase-heartbeat-database",Ao=1,Qe="firebase-heartbeat-store";let Wt=null;function Fi(){return Wt||(Wt=qr(xo,Ao,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Qe)}catch(n){console.warn(n)}}}}).catch(t=>{throw pe.create("idb-open",{originalErrorMessage:t.message})})),Wt}async function Lo(t){try{const n=(await Fi()).transaction(Qe),i=await n.objectStore(Qe).get(ji(t));return await n.done,i}catch(e){if(e instanceof me)ne.warn(e.message);else{const n=pe.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ne.warn(n.message)}}}async function Jn(t,e){try{const i=(await Fi()).transaction(Qe,"readwrite");await i.objectStore(Qe).put(e,ji(t)),await i.done}catch(n){if(n instanceof me)ne.warn(n.message);else{const i=pe.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});ne.warn(i.message)}}}function ji(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ro=1024,$o=30;class Po{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new No(n),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){var e,n;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=Yn();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)==null?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(o=>o.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:s}),this._heartbeatsCache.heartbeats.length>$o){const o=Mo(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(i){ne.warn(i)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Yn(),{heartbeatsToSend:i,unsentEntries:s}=Do(this._heartbeatsCache.heartbeats),r=Ri(JSON.stringify({version:2,heartbeats:i}));return this._heartbeatsCache.lastSentHeartbeatDate=n,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(n){return ne.warn(n),""}}}function Yn(){return new Date().toISOString().substring(0,10)}function Do(t,e=Ro){const n=[];let i=t.slice();for(const s of t){const r=n.find(o=>o.agent===s.agent);if(r){if(r.dates.push(s.date),Qn(n)>e){r.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),Qn(n)>e){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}class No{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return wr()?br().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await Lo(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return Jn(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return Jn(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Qn(t){return Ri(JSON.stringify({version:2,heartbeats:t})).length}function Mo(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let i=1;i<t.length;i++)t[i].date<n&&(n=t[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oo(t){Ye(new $e("platform-logger",e=>new Gr(e),"PRIVATE")),Ye(new $e("heartbeat",e=>new Po(e),"PRIVATE")),Te(tn,Gn,t),Te(tn,Gn,"esm2020"),Te("fire-js","")}Oo("");var Uo="firebase",Ho="12.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Te(Uo,Ho,"app");function Bi(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Fo=Bi,zi=new nt("auth","Firebase",Bi());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const It=new Ni("@firebase/auth");function jo(t,...e){It.logLevel<=I.WARN&&It.warn(`Auth (${st}): ${t}`,...e)}function ft(t,...e){It.logLevel<=I.ERROR&&It.error(`Auth (${st}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function M(t,...e){throw vn(t,...e)}function B(t,...e){return vn(t,...e)}function yn(t,e,n){const i={...Fo(),[e]:n};return new nt("auth","Firebase",i).create(e,{appName:t.name})}function V(t){return yn(t,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function qi(t,e,n){const i=n;if(!(e instanceof i))throw i.name!==e.constructor.name&&M(t,"argument-error"),yn(t,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function vn(t,...e){if(typeof t!="string"){const n=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=t.name),t._errorFactory.create(n,...i)}return zi.create(t,...e)}function g(t,e,...n){if(!t)throw vn(e,...n)}function ee(t){const e="INTERNAL ASSERTION FAILED: "+t;throw ft(e),new Error(e)}function ie(t,e){t||ee(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rn(){var t;return typeof self<"u"&&((t=self.location)==null?void 0:t.href)||""}function Bo(){return Xn()==="http:"||Xn()==="https:"}function Xn(){var t;return typeof self<"u"&&((t=self.location)==null?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function We(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Zo(t,e=!1){const n=K(t),i=await n.getIdToken(e),s=bn(i);g(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:We(Gt(s.auth_time)),issuedAtTime:We(Gt(s.iat)),expirationTime:We(Gt(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Gt(t){return Number(t)*1e3}function bn(t){const[e,n,i]=t.split(".");if(e===void 0||n===void 0||i===void 0)return ft("JWT malformed, contained fewer than 3 sections"),null;try{const s=$i(n);return s?JSON.parse(s):(ft("Failed to decode base64 JWT payload"),null)}catch(s){return ft("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function ei(t){const e=bn(t);return g(e,"internal-error"),g(typeof e.exp<"u","internal-error"),g(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sa(t,e){const n=await Wi(t,{},async()=>{const i=it({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=t.config,o=await Gi(t,s,"/v1/token",`key=${r}`),l=await t._getAdditionalHeaders();l["Content-Type"]="application/x-www-form-urlencoded";const d={method:"POST",headers:l,body:i};return t.emulatorConfig&&Rt(t.emulatorConfig.host)&&(d.credentials="include"),Vi.fetch()(o,d)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function ra(t,e){return re(t,"POST","/v2/accounts:revokeToken",ge(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ti=new Map;function te(t){ie(t instanceof Function,"Expected a class definition");let e=ti.get(t);return e?(ie(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,ti.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ji{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Ji.type="NONE";const ni=Ji;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Zi(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Yi(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(ts(e))return"Blackberry";if(ns(e))return"Webos";if(Qi(e))return"Safari";if((e.includes("chrome/")||Xi(e))&&!e.includes("edge/"))return"Chrome";if(es(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Yi(t=A()){return/firefox\//i.test(t)}function Qi(t=A()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Xi(t=A()){return/crios\//i.test(t)}function Zi(t=A()){return/iemobile/i.test(t)}function es(t=A()){return/android/i.test(t)}function ts(t=A()){return/blackberry/i.test(t)}function ns(t=A()){return/webos/i.test(t)}function In(t=A()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function oa(t=A()){var e;return In(t)&&!!((e=window.navigator)!=null&&e.standalone)}function aa(){return vr()&&document.documentMode===10}function is(t=A()){return In(t)||es(t)||ns(t)||ts(t)||/windows phone/i.test(t)||Zi(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ss(t,e=[]){let n;switch(t){case"Browser":n=ii(A());break;case"Worker":n=`${ii(A())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${st}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $t={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function fa(t){$t=t}function rs(t){return $t.loadJS(t)}function pa(){return $t.recaptchaEnterpriseScript}function ma(){return $t.gapiScript}function ga(t){return`__${t}${Math.floor(Math.random()*1e6)}`}class ya{constructor(){this.enterprise=new va}ready(e){e()}execute(e,n){return Promise.resolve("token")}render(e,n){return""}}class va{ready(e){e()}execute(e,n){return Promise.resolve("token")}render(e,n){return""}}const wa="recaptcha-enterprise",os="NO_RECAPTCHA";class ba{constructor(e){this.type=wa,this.auth=J(e)}async verify(e="verify",n=!1){async function i(r){if(!n){if(r.tenantId==null&&r._agentRecaptchaConfig!=null)return r._agentRecaptchaConfig.siteKey;if(r.tenantId!=null&&r._tenantRecaptchaConfigs[r.tenantId]!==void 0)return r._tenantRecaptchaConfigs[r.tenantId].siteKey}return new Promise(async(o,l)=>{Qo(r,{clientType:"CLIENT_TYPE_WEB",version:"RECAPTCHA_ENTERPRISE"}).then(d=>{if(d.recaptchaKey===void 0)l(new Error("recaptcha Enterprise site key undefined"));else{const u=new Yo(d);return r.tenantId==null?r._agentRecaptchaConfig=u:r._tenantRecaptchaConfigs[r.tenantId]=u,o(u.siteKey)}}).catch(d=>{l(d)})})}function s(r,o,l){const d=window.grecaptcha;Zn(d)?d.enterprise.ready(()=>{d.enterprise.execute(r,{action:e}).then(u=>{o(u)}).catch(()=>{o(os)})}):l(Error("No reCAPTCHA enterprise script loaded."))}return this.auth.settings.appVerificationDisabledForTesting?new ya().execute("siteKey",{action:"verify"}):new Promise((r,o)=>{i(this.auth).then(l=>{if(!n&&Zn(window.grecaptcha))s(l,r,o);else{if(typeof window>"u"){o(new Error("RecaptchaVerifier is only supported in browser"));return}let d=pa();d.length!==0&&(d+=l),rs(d).then(()=>{s(l,r,o)}).catch(u=>{o(u)})}}).catch(l=>{o(l)})})}}async function ri(t,e,n,i=!1,s=!1){const r=new ba(t);let o;if(s)o=os;else try{o=await r.verify(n)}catch{o=await r.verify(n,!0)}const l={...e};if(n==="mfaSmsEnrollment"||n==="mfaSmsSignIn"){if("phoneEnrollmentInfo"in l){const d=l.phoneEnrollmentInfo.phoneNumber,u=l.phoneEnrollmentInfo.recaptchaToken;Object.assign(l,{phoneEnrollmentInfo:{phoneNumber:d,recaptchaToken:u,captchaResponse:o,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}else if("phoneSignInInfo"in l){const d=l.phoneSignInInfo.recaptchaToken;Object.assign(l,{phoneSignInInfo:{recaptchaToken:d,captchaResponse:o,clientType:"CLIENT_TYPE_WEB",recaptchaVersion:"RECAPTCHA_ENTERPRISE"}})}return l}return i?Object.assign(l,{captchaResp:o}):Object.assign(l,{captchaResponse:o}),Object.assign(l,{clientType:"CLIENT_TYPE_WEB"}),Object.assign(l,{recaptchaVersion:"RECAPTCHA_ENTERPRISE"}),l}async function an(t,e,n,i,s){var r;if((r=t._getRecaptchaConfig())!=null&&r.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")){const o=await ri(t,e,n,n==="getOobCode");return i(t,o)}else return i(t,e).catch(async o=>{if(o.code==="auth/missing-recaptcha-token"){console.log(`${n} is protected by reCAPTCHA Enterprise for this project. Automatically triggering the reCAPTCHA flow and restarting the flow.`);const l=await ri(t,e,n,n==="getOobCode");return i(t,l)}else return Promise.reject(o)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ia(t,e){const n=Ui(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),r=n.getOptions();if(Re(r,e??{}))return s;M(s,"already-initialized")}return n.initialize({options:e})}function ka(t,e){const n=(e==null?void 0:e.persistence)||[],i=(Array.isArray(n)?n:[n]).map(te);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function _a(t,e,n){const i=J(t);g(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,r=as(e),{host:o,port:l}=Sa(e),d=l===null?"":`:${l}`,u={url:`${r}//${o}${d}/`},h=Object.freeze({host:o,port:l,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!i._canInitEmulator){g(i.config.emulator&&i.emulatorConfig,i,"emulator-config-failed"),g(Re(u,i.config.emulator)&&Re(h,i.emulatorConfig),i,"emulator-config-failed");return}i.config.emulator=u,i.emulatorConfig=h,i.settings.appVerificationDisabledForTesting=!0,Rt(o)?(dr(`${r}//${o}${d}`),fr("Auth",!0)):Ea()}function as(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function Sa(t){const e=as(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const i=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:oi(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:oi(o)}}}function oi(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function Ea(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class be{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,i,s=!1){const r=await F._fromIdTokenResponse(e,i,s),o=ai(i);return new be({user:r,providerId:o,_tokenResponse:i,operationType:n})}static async _forOperation(e,n,i){await e._updateTokensIfNecessary(i,!0);const s=ai(i);return new be({user:e,providerId:s,_tokenResponse:i,operationType:n})}}function ai(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ls(t,e,n=!1){if($(t.app))return Promise.reject(V(t));const i="signIn",s=await cs(t,i,e),r=await be._fromIdTokenResponse(t,i,s);return n||await t._updateCurrentUser(r.user),r}async function Ma(t,e){return ls(J(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ds(t){const e=J(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Oa(t,e,n){if($(t.app))return Promise.reject(V(t));const i=J(t),o=await an(i,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Pa).catch(d=>{throw d.code==="auth/password-does-not-meet-requirements"&&ds(t),d}),l=await be._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(l.user),l}function Ua(t,e,n){return $(t.app)?Promise.reject(V(t)):Ma(K(t),Ne.credential(e,n)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&ds(t),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class us{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(Et,"1"),this.storage.removeItem(Et),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fs extends us{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}fs.type="SESSION";const ps=fs;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(){return typeof W().WorkerGlobalScope<"u"&&typeof W().importScripts=="function"}async function Qa(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Xa(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)==null?void 0:t.controller)||null}function Za(){return ms()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,n,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:i,postBody:s,tenantId:r,error:o,type:l}=e;if(o){this.reject(o);return}const d={auth:this.auth,requestUri:n,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(d))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return oc;case"linkViaPopup":case"linkViaRedirect":return cc;case"reauthViaPopup":case"reauthViaRedirect":return ac;default:M(this.auth,"internal-error")}}resolve(e){ie(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){ie(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc="pendingRedirect",mt=new Map;class uc extends ws{constructor(e,n,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let e=mt.get(this.auth._key());if(!e){try{const i=await hc(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(n){e=()=>Promise.reject(n)}mt.set(this.auth._key(),e)}return this.bypassAuthState||mt.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function hc(t,e){const n=ks(e),i=Is(t);if(!await i._isAvailable())return!1;const s=await i._get(n)==="true";return await i._remove(n),s}async function fc(t,e){return Is(t)._set(ks(e),"true")}function pc(t,e){mt.set(t._key(),e)}function Is(t){return te(t._redirectPersistence)}function ks(t){return pt(dc,t.config.apiKey,t.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _s(t,e,n){return mc(t,e,n)}async function mc(t,e,n){if($(t.app))return Promise.reject(V(t));const i=J(t);qi(t,e,Pt),await i._initializationPromise;const s=En(i,n);return await fc(s,i),s._openRedirect(i,e,"signInViaRedirect")}async function gc(t,e){return await J(t)._initializationPromise,Ss(t,e,!1)}async function Ss(t,e,n=!1){if($(t.app))return Promise.reject(V(t));const i=J(t),s=En(i,e),o=await new uc(i,s,n).execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yc=600*1e3;class vc{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(n=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!wc(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var i;if(e.error&&!Es(e)){const s=((i=e.error.code)==null?void 0:i.split("auth/")[1])||"internal-error";n.onError(B(this.auth,s))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const i=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=yc&&this.cachedEventUids.clear(),this.cachedEventUids.has(di(e))}saveEventToCache(e){this.cachedEventUids.add(di(e)),this.lastProcessedEventTime=Date.now()}}function di(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function Es({type:t,error:e}){return t==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function wc(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Es(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ec=new rt(3e4,6e4);function ui(){const t=W().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function Cc(t){return new Promise((e,n)=>{var s,r,o;function i(){ui(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{ui(),n(B(t,"network-request-failed"))},timeout:Ec.get()})}if((r=(s=W().gapi)==null?void 0:s.iframes)!=null&&r.Iframe)e(gapi.iframes.getContext());else if((o=W().gapi)!=null&&o.load)i();else{const l=ga("iframefcb");return W()[l]=()=>{gapi.load?i():n(B(t,"network-request-failed"))},rs(`${ma()}?onload=${l}`).catch(d=>n(d))}}).catch(e=>{throw gt=null,e})}let gt=null;function Tc(t){return gt=gt||Cc(t),gt}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nc={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Mc=500,Oc=600,Uc="_blank",Hc="http://localhost";class hi{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Fc(t,e,n,i=Mc,s=Oc){const r=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let l="";const d={...Nc,width:i.toString(),height:s.toString(),top:r,left:o},u=A().toLowerCase();n&&(l=Xi(u)?Uc:n),Yi(u)&&(e=e||Hc,d.scrollbars="yes");const h=Object.entries(d).reduce((p,[v,_])=>`${p}${v}=${_},`,"");if(oa(u)&&l!=="_self")return jc(e||"",l),new hi(null);const m=window.open(e||"",l,h);g(m,t,"popup-blocked");try{m.focus()}catch{}return new hi(m)}function jc(t,e){const n=document.createElement("a");n.href=t,n.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`)){const r=s.toLowerCase();r.includes("fridge")?i="fridge":r.includes("freezer")?i="freezer":r.includes("pantry")&&(i="pantry");const o=s.match(/^\|\s*([^|]+?)\s*\|\s*(\d+(?:\.\d+)?)\s*\|\s*([^|]+?)\s*\|/),l=s.match(/^[-*]\s+(.+?):\s*(\d+(?:\.\d+)?)\s*([a-zA-Z%\/]+.*)?$/);let d,u,h;if(o?(d=o[1].trim(),u=parseFloat(o[2]),h=o[3].trim()):l&&(d=l[1].trim(),u=parseFloat(l[2]),h=(l[3]||"unit").trim()),d&&u&&d!=="Item"&&d!=="---"&&!d.startsWith("-")){const m="item-imp-"+d.toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),p=a.inv.find(v=>v.id===m);await oe({id:m,barcode:m,name:d,brand:"",unit:h||"unit",qty:u,location:i,category:"Imported",image:null,source:"Imported",nutrition:null,expiry:null,addedAt:p?p.addedAt:new Date().toLocaleDateString()}),p?n++:e++}}c("imptxt").value="",f(`Imported ${e} new, updated ${n}`),L("import")}let N=null,Yt=!1,Be="";function Vl(){if(!(window.SpeechRecognition||window.webkitSpeechRecognition))return;const e=c("micbtn");e&&(e.style.display="")}function wi(t){const e=c("micbtn"),n=c("micstatus");e&&e.classList.toggle("mic-active",t),n&&n.classList.toggle("visible",t)}function Wl(){if(Yt&&N){N.stop();return}const t=window.SpeechRecognition||window.webkitSpeechRecognition;if(!t){f("Voice input not supported");return}N=new t,N.lang="en-US",N.interimResults=!0,N.maxAlternatives=1,N.continuous=!1,Be="",Yt=!0,wi(!0);const e=c("shi");e&&(e.value="",e.placeholder="Speak now..."),N.onresult=n=>{let i="";for(let r=n.resultIndex;r<n.results.length;r++){const o=n.results[r][0].transcript;n.results[r].isFinal?Be+=o:i+=o}const s=c("shi");s&&(s.value=(Be+i).trim())},N.onerror=n=>{n.error!=="no-speech"&&n.error!=="aborted"&&f("Couldn't hear that — try again")},N.onend=()=>{const n=(Be||"").trim();Yt=!1,N=null,Be="",wi(!1);const i=c("shi");i&&(i.placeholder="Add item…"),n&&i&&(i.value=n,Ms(),f(`Added "${n}" 🎤`))},N.start()}function ht(t){const e=t.qty||1,n=`<span class="sh-qty${e===1?" sh-qty-one":""}" onclick="event.stopPropagation();openShQty('${t.id}')"> × ${e}</span>`;return`<div class="swipe-wrap" id="sw-${t.id}" data-id="${t.id}" data-list="shop">
  ...
  </div>`}function lt(){const t=(o,l)=>o.name.localeCompare(l.name),e=c("shlist"),n=a.shop.filter(o=>!o.checked).sort(t),i=a.shop.filter(o=>o.checked).sort(t),s=c("clrchk");s&&(s.style.display=i.length?"block":"none");const r=c("shsub");if(r&&(r.textContent=n.length+" items to buy"),!!e){if(!a.shop.length){e.innerHTML='<div class="es"><div class="ei">🛒</div><p>Your list is empty!<br/>Add items or use "Build from meal plan".</p></div>';return}if(a.aisleMode&&n.length){const o={};n.forEach(l=>{const d=Al(l.name);o[d]||(o[d]=[]),o[d].push(l)}),e.innerHTML=Object.entries(o).sort().map(([l,d])=>`<div class="shsec">${l}</div>${d.map(ht).join("")}`).join("")+(i.length?`<div class="shsec">Done</div>${i.map(ht).join("")}`:"")}else e.innerHTML=(n.length?`<div class="shsec">To buy (${n.length})</div>${n.map(ht).join("")}`:"")+(i.length?`<div class="shsec">Done</div>${i.map(ht).join("")}`:"");if(a.selectMode==="shop"){document.querySelectorAll("#shlist .swipe-wrap").forEach(l=>{l.classList.add("selecting"),a.selectedIds.has(l.dataset.id)&&l.classList.add("selected")});const o=document.querySelector(".shbody");o&&(o.style.paddingLeft="52px")}}}function Ms(){const t=c("shi"),e=t.value.trim();if(!e)return;let n=e,i=1;const s=e.match(/^(\d+)\s+(.+)/),r=e.match(/^(.+?)\s*[x×]\s*(\d+)$/i);r?(n=r[1].trim(),i=parseInt(r[2],10)||1):s&&(n=s[2].trim(),i=parseInt(s[1],10)||1),ae({id:Date.now().toString(),name:n,qty:i,checked:!1,src:"manual"}),t.value=""}function Os(t){if(!a.hid||!t)return;const e=Date.now().toString(36)+Math.random().toString(36).slice(2,6);w(`households/${a.hid}/completed_items/${e}`,{name:t,completedAt:new Date().toISOString()}).catch(n=>console.warn("recordCompleted error:",n))}function Gl(t){const e=a.shop.find(i=>i.id===t);if(!e)return;const n=!e.checked;ae({...e,checked:n}),n&&Os(e.name)}function Kl(t,e){t.stopPropagation();const n=c("sne-"+e),i=c("sni-"+e);if(!n)return;n.classList.toggle("open")&&i&&(i.focus(),i.setSelectionRange(i.value.length,i.value.length))}function Jl(t){const e=c("sni-"+t);if(!e)return;const n=a.shop.find(s=>s.id===t);if(!n)return;const i=e.value.trim();i!==(n.note||"")&&ae({...n,note:i})}function Yl(t){const e=c("sqe-"+t),n=c("sqi-"+t);if(!e)return;e.classList.toggle("open")&&n&&(n.focus(),n.select())}function Ql(t,e){const n=c("sqi-"+t);if(!n)return;const i=Math.max(1,(parseInt(n.value,10)||1)+e);n.value=i,Us(t)}function Us(t){const e=c("sqi-"+t);if(!e)return;const n=a.shop.find(s=>s.id===t);if(!n)return;const i=Math.max(1,parseInt(e.value,10)||1);i!==(n.qty||1)&&ae({...n,qty:i})}function Xl(){a.aisleMode=!a.aisleMode;const t=c("aislebtn");t&&(t.style.background=a.aisleMode?"var(--ac)":"",t.style.color=a.aisleMode?"var(--bg)":""),lt()}function Zl(t){["list","deals"].forEach(i=>{const s=c("shtab-"+i);s&&s.classList.remove("active");const r=c("sh-"+i+"-body");r&&(r.style.display="none")});const e=c("shtab-"+t);e&&e.classList.add("active");const n=c("sh-"+t+"-body");n&&(n.style.display="block"),t==="deals"&&Hs()}function ed(){const t=a.shop.filter(i=>!i.checked);if(!t.length){f("List is empty!");return}const n=`🛒 Shopping List

`+t.map(i=>{let s="• "+i.name;return(i.qty||1)>1&&(s+=" × "+i.qty),i.price&&(s+=" (~$"+i.price+")"),s}).join(`
`);navigator.share?navigator.share({title:"Shopping List",text:n}).catch(()=>{}):navigator.clipboard&&navigator.clipboard.writeText(n).then(()=>f("List copied!"))}function td(){const t=a.shop.filter(n=>n.checked);if(!t.length){f("No completed items!");return}const e=c("atk-body");e.innerHTML=`<div style="padding:16px">
  ...
  </div>`,ye("atk")}function nd(t,e,n){const i=c("atk-"+t);i.dataset.loc=e,i.querySelectorAll(".atk-loc button").forEach(s=>s.classList.remove("sel")),n.classList.add("sel")}async function id(){const t=a.shop.filter(i=>i.checked),e=new Date().toLocaleDateString();let n=0;for(const i of t){const s=c("atk-"+i.id);if(!s)continue;const r=s.dataset.loc||$s(i.name),o=a.inv.find(d=>d.name.toLowerCase()===i.name.toLowerCase()),l=i.qty||1;await oe({id:o?o.id:"inv-"+Date.now()+"-"+Math.random().toString(36).slice(2),name:o?o.name:i.name,qty:o?o.qty+l:l,unit:o?o.unit:"unit",location:r,category:o?o.category:Ze({name:i.name}),addedAt:o?o.addedAt:e,brand:o?o.brand:"",expiry:o?o.expiry:null,image:o?o.image:null,source:"shopping"}),await Ot(i.id),n++}L("atk"),f(`${n} item${n!==1?"s":""} added to your kitchen! 🧺`)}async function sd(){const t=He().map(s=>{const r=s.toISOString().split("T")[0];return a.mp[r]?`${s.toLocaleDateString("en-US",{weekday:"short"})}: ${a.mp[r]}`:""}).filter(Boolean).join(", ");if(!t){f("No meals planned yet!");return}const e=a.inv.map(s=>`${s.name} (${s.qty} ${s.unit})`).join(", "),n=document.querySelector('[onclick="buildList()"]'),i=n?n.textContent:"";n&&(n.disabled=!0,n.textContent="⏳ Thinking…");try{const r=await(await fetch("/api/proxy",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-haiku-4-5-20251001",max_tokens:500,messages:[{role:"user",content:`Week meals: ${t}
Already have: ${e}
...
Recipe: ${e.description}`}]})})).json(),r=(s.content&&s.content[0]&&s.content[0].text||"").replace(/```json|```/g,"").trim(),l=JSON.parse(r).filter(d=>!n.some(u=>u.includes(d.toLowerCase())||d.toLowerCase().includes(u)));if(!l.length){f("All ingredients already in pantry ✓");return}for(const d of l)await ae({id:"shop-"+Date.now()+"-"+Math.random().toString(36).slice(2),name:d,qty:1,checked:!1,src:"recipe"});f(`Added ${l.length} ingredient${l.length!==1?"s":""} to shopping list 🛒`),L("erec"),window.showScreen("shopping")}catch{f("Couldn't parse ingredients")}}function Sd(t,e){a.nr=t,e==="r"?Je("rstars",t):e==="c"?Je("cstars",t):e==="e"&&Je("estars",t)}async function Ed(t){const e=a.recs.find(r=>r.id===t);if(!e)return;const n=!e.isPublic,i=D(),s=(i==null?void 0:i.displayName)||localStorage.getItem("ks-who")||"Anonymous";n?(await vl(e,s,a.hid),f("Recipe shared with the community!")):(await wl(e.id),f("Recipe removed from community")),await ke({...e,isPublic:n})}async function Nn(){const t=c("rbody");if(t){t.innerHTML='<div class="es"><div class="ei">🌍</div><p>Loading community recipes…</p></div>';try{a.comRecs=await bl(),Mn()}catch(e){console.error("loadCommunity:",e),t.innerHTML=`<div class="es"><div class="ei">⚠️</div><p>Couldn't load community recipes.</p></div>`}}}function Cd(t){a.comCuisine=t,Mn()}function Td(t){a.comSearch=t,Mn()}function Mn(){const t=c("rbody");if(!t)return;let e=[...a.comRecs];if(a.comCuisine&&a.comCuisine!=="all"&&(e=e.filter(s=>(s.cuisine||"").toLowerCase().includes(a.comCuisine.toLowerCase())||(s.tags||[]).some(r=>r.toLowerCase().includes(a.comCuisine.toLowerCase())))),a.comSearch){const s=a.comSearch.toLowerCase();e=e.filter(r=>(r.title||"").toLowerCase().includes(s)||(r.tags||[]).join(" ").toLowerCase().includes(s)||(r.cuisine||"").toLowerCase().includes(s)||(r.authorName||"").toLowerCase().includes(s))}e.sort((s,r)=>new Date(r.createdAt||0)-new Date(s.createdAt||0));const n=c("rsub");n&&(n.textContent=e.length+" community recipe"+(e.length!==1?"s":""));let i=`<div style="margin-bottom:14px">
    ...
    </div>`}),t.innerHTML=i}async function xd(t){const e=a.comRecs.find(d=>d.id===t);if(!e)return;await Sl(t)?a.myLikes.add(t):a.myLikes.delete(t);let i=[];try{i=await _l(t)}catch{}i.sort((d,u)=>new Date(d.createdAt||0)-new Date(u.createdAt||0));const s=`https://pantry-app-zeta-six.vercel.app/recipe/${t}`;let r=i.map(d=>`<div style="padding:10px 0;border-bottom:1px solid var(--b1)">
    ...
    <div style="margin-top:16px;padding:12px;background:var(--card);border:1px solid var(--b1);border-radius:12px">
    ...
    </div>`,ye("erec")}async function Ad(t){if(!D()){f("Sign in to like recipes");return}const n=a.myLikes.has(t);try{await Il(t,n),n?a.myLikes.delete(t):a.myLikes.add(t);const i=a.comRecs.find(r=>r.id===t);i&&(i.likes=(i.likes||0)+(n?-1:1));const s=c("com-like-btn");if(s){const r=a.myLikes.has(t);s.className=`btn ${r?"bp":"bs"} bsm`,s.innerHTML=`${r?"❤️":"🤍"} ${(i==null?void 0:i.likes)||0} Like${((i==null?void 0:i.likes)||0)!==1?"s":""}`}f(n?"Like removed":"Liked!")}catch(i){console.error("likeComRecipe:",i),f("Couldn't update like")}}async function Ld(t){if(!D()){f("Sign in to save recipes");return}const n=a.comRecs.find(i=>i.id===t);if(n)try{await El(n),f("Recipe saved to your kitchen! 📖"),L("erec")}catch(i){console.error("saveComToKitchen:",i),f("Couldn't save recipe")}}async function Rd(t){var r;const e=D();if(!e){f("Sign in to comment");return}const n=c("com-cmt-input"),i=(r=n==null?void 0:n.value)==null?void 0:r.trim();if(!i)return;const s=e.displayName||localStorage.getItem("ks-who")||"Anonymous";try{const o=await kl(t,i,s);n.value="";const l=c("com-comments");l&&o&&(l.querySelector("div[style*='color:var(--mt)']")&&!l.querySelector("div[style*='border-bottom']")&&(l.innerHTML=""),l.innerHTML+=`<div style="padding:10px 0;border-bottom:1px solid var(--b1)">
        <div style="display:flex;justify-content:space-between;align-items:center">
      ...
      </div>`),f("Comment posted!")}catch(o){console.error("addComComment:",o),f("Couldn't post comment")}}async function $d(t){const e=a.comRecs.find(s=>s.id===t),n=`https://pantry-app-zeta-six.vercel.app/recipe/${t}`,i=(e==null?void 0:e.title)||"Recipe";if(navigator.share)try{await navigator.share({title:i,text:`Check out this recipe: ${i}`,url:n});return}catch{}try{await navigator.clipboard.writeText(n),f("Link copied!")}catch{f("Couldn't copy link")}}function Pd(){const t=a.cookLog,e=a.wasteLog;let n=0;for(let b=0;b<60;b++){const S=new Date;S.setDate(S.getDate()-b);const R=S.toISOString().split("T")[0];if(t.find(U=>U.date===R))n++;else if(b>0)break}const i=c("ins-streak-num");i&&(i.textContent=n);const s=c("ins-total-cooked");s&&(s.textContent=t.length);const r=c("ins-waste-count");r&&(r.textContent=e.length);const o=c("ins-sub");o&&(o.textContent=t.length?" "+t.length+" meals cooked":"Your kitchen at a glance");const l=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],d=c("ins-week");if(d){const b=He().map(S=>{const R=S.toISOString().split("T")[0],U=a.mp[R],E=R===he();return`<div style="display:flex;align-items:center;gap:10px;padding:7px 0;border-bottom:1px solid var(--b1)${E?";background:var(--acd);margin:0 -4px;padding:7px 4px;border-radius:6px":""}">
        <div style="font-size:.72rem;color:var(--mt);min-width:30px;font-weight:${E?"600":"400"}">${l[S.getDay()]}</div>
...
Be concise. Use what they have. Suggest variety — lean toward Bangladeshi and Turkish — avoid repeating recent meals. Format grocery lists as bullet points starting "- ".`}function Nd(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/^\d+\.\s+(.+)$/gm,"<li>$1</li>").replace(/^[-•]\s+(.+)$/gm,"<li>$1</li>").replace(/\n/g,"<br>")}async function Bs(){const t=c("chi"),e=t.value.trim();if(!e)return;t.value="",zs(t),a.chat.push({role:"user",content:e}),Qt("user",e);const n=c("csb");n&&(n.disabled=!0);const i="thinking-"+Date.now(),s=c("chmsgs");s.innerHTML+=`<div class="cb asst thinking" id="${i}">Thinking…</div>`,s.scrollTop=s.scrollHeight;try{const o=await(await fetch("/api/proxy",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-haiku-4-5-20251001",max_tokens:800,system:Dd(),messages:a.chat.map(u=>({role:u.role,content:u.content}))})})).json(),l=o.content&&o.content[0]&&o.content[0].text||"Sorry, I couldn't process that.",d=c(i);d&&d.remove(),a.chat.push({role:"assistant",content:l}),Qt("assistant",l)}catch{const o=c(i);o&&o.remove(),Qt("assistant","Sorry, I couldn't reach Claude. Check your connection and try again.")}n&&(n.disabled=!1)}function Qt(t,e){const n=c("chmsgs");if(!n)return;const i=document.createElement("div");i.className="cb "+(t==="user"?"user":"asst"),i.innerHTML=t==="user"?e:Nd(e),n.appendChild(i),n.scrollTop=n.scrollHeight}function Md(t){const e=c("chi");e&&(e.value=t.textContent),Bs()}function Od(){a.chat=[];const t=c("chmsgs");t&&(t.innerHTML='<div class="cb asst">Hey! 👋 I know your full inventory, meal plan, and saved recipes. What do you need?</div>')}function zs(t){t.style.height="auto",t.style.height=Math.min(t.scrollHeight,120)+"px"}const Ud="2b6ecac2",Hd="8db76605e873aaf2fbdf41256cb24cb4";function Fd(){c("scerr").style.display="none",c("ffile").click()}function jd(){a.scanDestList=!0,ye("scan");const t=c("scanovttl");t&&(t.textContent="Scan → Shopping List");const e=c("scan-dest-hint");e&&(e.textContent="Running low? Scan to add to your shopping list.")}function Bd(){a.scanDestList=!1,ye("scan");const t=c("scanovttl");t&&(t.textContent="Scan Barcode");const e=c("scan-dest-hint");e&&(e.textContent="Scan a barcode to add to your pantry or shopping list.")}function zd(){if(!a.cp)return;const t=a.cp.notFound?"Barcode "+a.cp.barcode:a.cp.name,e=parseInt(c("aqty").value)||1,n=c("aunit").value.trim(),i=t+(e>1||n?" ("+e+(n?" "+n:"")+")":"");ae({id:Date.now().toString(),name:i,qty:1,checked:!1,src:"scan"}),f("Added to list: "+t),L("result"),L("scan"),a.scanDestList=!1,window.showScreen("shopping")}function qd(){const t=c("mentry");t.style.display=t.style.display==="none"?"block":"none"}async function Vd(t){const e=t.target.files[0];if(!e)return;t.target.value="",c("scanbody").style.display="none",c("scspin").style.display="block",c("scst").textContent="Reading image…";const n=await new Promise((i,s)=>{const r=new FileReader;r.onload=o=>i(o.target.result),r.onerror=s,r.readAsDataURL(e)});try{c("scst").textContent="Detecting barcode…";const i=await new Promise((r,o)=>Quagga.decodeSingle({src:n,numOfWorkers:0,inputStream:{size:1600},decoder:{readers:["ean_reader","ean_8_reader","upc_reader","upc_e_reader","code_128_reader","code_39_reader"],multiple:!1},locate:!0},l=>{l&&l.codeResult&&l.codeResult.code?r(l.codeResult.code):o("no")}));c("scst").textContent="Found "+i+" — looking up…";const s=await qs(i);a.cp=s,c("aqty").value=1,c("aexp").value="",On("fridge",c("rl-fridge")),Vs(s),c("scanbody").style.display="block",c("scspin").style.display="none"}catch{c("scanbody").style.display="block",c("scspin").style.display="none";const i=c("scerr");i.textContent="⚠️ No barcode detected. Try better lighting or enter manually.",i.style.display="block"}}async function Wd(){const t=c("meinp").value.trim();if(!t)return;c("scanbody").style.display="none",c("scspin").style.display="block",c("scst").textContent="Looking up…";const e=await qs(t);a.cp=e,c("aqty").value=1,c("aexp").value="",On("fridge",c("rl-fridge")),c("meinp").value="",Vs(e),c("scanbody").style.display="block",c("scspin").style.display="none"}async function qs(t){return await Gd(t)||await Kd(t)||await Jd(t)||{barcode:t,name:"",brand:"",quantity:"",category:"General",image:null,source:null,notFound:!0}}async function Gd(t){try{const e=await fetch(`https://api.edamam.com/api/food-database/v2/parser?upc=${t}&app_id=${Ud}&app_key=${Hd}`);if(!e.ok)return null;const n=await e.json(),i=n.hints&&n.hints[0]&&n.hints[0].food||n.parsed&&n.parsed[0]&&n.parsed[0].food;if(!i)return null;const s=i.nutrients||{};return{barcode:t,name:i.label||"",brand:i.brand||"",quantity:i.servingSize?`${i.servingSize}${i.servingSizeUnit||"g"}`:"",category:i.category||"General",image:i.image||null,source:"Edamam",notFound:!1,nutrition:{calories:s.ENERC_KCAL?Math.round(s.ENERC_KCAL):null,protein:s.PROCNT?`${s.PROCNT.toFixed(1)}g`:null,fat:s.FAT?`${s.FAT.toFixed(1)}g`:null,carbs:s.CHOCDF?`${s.CHOCDF.toFixed(1)}g`:null}}}catch{}return null}async function Kd(t){try{const n=await(await fetch("https://world.openfoodfacts.org/api/v0/product/"+t+".json")).json();if(n.status===1&&n.product){const i=n.product,s=i.product_name||i.product_name_en||"";return s?{barcode:t,name:s,brand:i.brands||"",quantity:i.quantity||"",category:((i.categories_tags||[])[0]||"").replace("en:","")||"General",image:i.image_small_url||null,source:"Open Food Facts",notFound:!1,nutrition:null}:null}}catch{}return null}async function Jd(t){try{const n=await(await fetch("https://api.upcitemdb.com/prod/trial/lookup?upc="+t)).json();if(n.code==="OK"&&n.items&&n.items.length>0){const i=n.items[0];return{barcode:t,name:i.title||"",brand:i.brand||"",quantity:i.size||"",category:i.category||"General",image:(i.images||[])[0]||null,source:"UPC Item DB",notFound:!1,nutrition:null}}}catch{}return null}function Vs(t){L("scan"),c("resttl").textContent=t.notFound?"Not Found":"Product Found ✓",c("aunit").value=t.quantity||"unit";let e="";if(t.notFound)e=`<div class="nfb">⚠️ Barcode <code>${t.barcode}</code> not found. Enter name:<input class="fi" id="mnm" placeholder="Product name (required)" oninput="valAdd()" style="margin-top:10px"/></div>`,setTimeout(()=>c("addbtn").disabled=!0,0);else{const n=t.image?`<img src="${t.image}" class="pimg" onerror="this.style.display='none'"/>`:'<div class="pimg" style="display:flex;align-items:center;justify-content:center;font-size:1.8rem">🛒</div>';let i="";t.nutrition&&(t.nutrition.calories||t.nutrition.protein)&&(i=`<div class="ngrd">${[["Cal",t.nutrition.calories],["Protein",t.nutrition.protein],["Fat",t.nutrition.fat],["Carbs",t.nutrition.carbs]].map(([s,r])=>`<div class="nb"><div class="nv">${r||"—"}</div><div class="nl">${s}</div></div>`).join("")}</div>`),e=`<div class="pcard"><div class="phdr">${n}<div style="flex:1"><div class="pnm">${t.name}</div>${t.brand?`<div class="pbr">${t.brand}</div>`:""}<div class="pbc">${t.barcode}</div><span class="bdg">${t.category}</span>${t.source?`<span class="srcb">${t.source}</span>`:""}</div></div>${i}</div>`,setTimeout(()=>c("addbtn").disabled=!1,0)}c("resbody").innerHTML=e,ye("result")}function On(t,e){a.selR=t,document.querySelectorAll("#ov-result .lbtn").forEach(n=>n.classList.remove("sel")),e&&e.classList.add("sel")}function Yd(){const t=c("mnm");c("addbtn").disabled=!(t&&t.value.trim())}async function Qd(){if(!a.cp)return;const t=c("mnm"),e=a.cp.notFound?t&&t.value.trim()||"":a.cp.name;if(!e)return;const n=c("aunit").value.trim()||"unit",i=Math.max(1,parseInt(c("aqty").value)||1),s=c("aexp").value||null,r="item-"+a.cp.barcode.replace(/\W/g,"-"),o=a.inv.find(l=>l.id===r);await oe({id:r,barcode:a.cp.barcode,name:e,brand:a.cp.brand||"",unit:n,qty:o?o.qty+i:i,location:a.selR,category:a.cp.category||"General",image:a.cp.image||null,source:a.cp.source||null,nutrition:a.cp.nutrition||null,expiry:s,addedAt:o?o.addedAt:new Date().toLocaleDateString()}),f(o?`+${i} added to ${e}`:`${e} added!`),a.cp=null,L("result")}function Xd(t){const e=c("aqty");e.value=Math.max(1,(parseInt(e.value)||1)+t)}let Ce=null,bi=0,H=null;function Zd(){document.addEventListener("touchstart",t=>{const e=t.target.closest(".swipe-inner");!e||!e.closest(".swipe-wrap")||a.selectMode||(Ce=e,bi=t.touches[0].clientX,e.classList.add("swiping"))},{passive:!0}),document.addEventListener("touchmove",t=>{if(!Ce)return;const e=t.touches[0].clientX-bi,n=Math.max(-80,Math.min(0,e));Ce.style.transform=`translateX(${n}px)`,Math.abs(e)>8&&t.preventDefault()},{passive:!1}),document.addEventListener("touchend",()=>{if(!Ce)return;const t=Ce,e=t.closest(".swipe-wrap");t.classList.remove("swiping"),(parseFloat(t.style.transform.replace("translateX(",""))||0)<-50?(t.style.transform="translateX(-80px)",e==null||e.classList.add("open"),H&&H!==e&&pn(H),H=e):(t.style.transform="translateX(0)",e==null||e.classList.remove("open"),H===e&&(H=null)),Ce=null}),document.addEventListener("touchstart",t=>{if(!H||t.target.closest(".swipe-del"))return;const e=t.target.closest(".swipe-inner");e&&e.closest(".swipe-wrap")===H||(pn(H),H=null)},{passive:!0})}function pn(t){const e=t==null?void 0:t.querySelector(".swipe-inner");e&&(e.style.transform="translateX(0)"),t==null||t.classList.remove("open")}async function eu(t,e){const n=c("sw-"+t);n&&(n.style.opacity="0.5"),e==="shop"?await Ot(t):(await xn(t),f("Item removed"))}function tu(t,e){const n=c("sw-"+t);if(n){const i=n.querySelector(".swipe-inner");if((parseFloat((i.style.transform||"").replace("translateX(",""))||0)<-10){pn(n),H=null;return}}if(a.selectMode){a.selectedIds.has(t)?(a.selectedIds.delete(t),n==null||n.classList.remove("selected")):(a.selectedIds.add(t),n==null||n.classList.add("selected")),Ht();return}e==="shop"?window.togShop(t):window.openAdj(t)}function nu(){if(a.selectMode==="shop"){De();return}a.selectMode&&De(),a.selectMode="shop",a.selectedIds.clear(),document.querySelectorAll("#shlist .swipe-wrap").forEach(e=>e.classList.add("selecting"));const t=c("sh-selbtn");t&&(t.classList.add("active"),t.textContent="Cancel"),Ht()}function iu(){if(a.selectMode==="inv"){De();return}a.selectMode&&De(),a.selectMode="inv",a.selectedIds.clear(),document.querySelectorAll("#ibody .swipe-wrap").forEach(e=>e.classList.add("selecting"));const t=c("inv-selbtn");t&&(t.classList.add("active"),t.textContent="Cancel"),Ht()}function De(){a.selectMode=null,a.selectedIds.clear(),document.querySelectorAll(".swipe-wrap.selecting").forEach(n=>n.classList.remove("selecting","selected"));const t=c("sh-selbtn");t&&(t.classList.remove("active"),t.textContent="Select");const e=c("inv-selbtn");e&&(e.classList.remove("active"),e.textContent="Select"),Ht()}async function su(){if(!a.selectedIds.size)return;const t=[...a.selectedIds],e=a.selectMode;De(),e==="shop"?await Promise.all(t.map(n=>Ot(n))):await Promise.all(t.map(n=>xn(n))),f(`Removed ${t.length} item${t.length!==1?"s":""} 🗑`)}function Ht(){const t=c("multi-bar");if(!t)return;const e=a.selectedIds.size,n=c("multi-count");n&&(n.textContent=e),a.selectMode?t.classList.add("visible"):t.classList.remove("visible")}const ru=["Chicken","Beef","Fish","Vegetarian","Vegan","Quick","Kids","Healthy","Batch Cook","Date Night"];function Ws(t){return"chip-"+t.split(" ").join("-")}function Gs(){const t=c("recChips");t&&(t.innerHTML=ru.map(e=>`<button onclick="toggleChip('${e}')" id="${Ws(e)}" style="padding:5px 10px;border-radius:20px;border:1px solid var(--bd);background:var(--s2);color:var(--tx2);font-size:.78rem;cursor:pointer;transition:all .15s">${e}</button>`).join(""))}function ou(t){const e=c(Ws(t));window._activeChips.has(t)?(window._activeChips.delete(t),e&&(e.style.background="var(--s2)",e.style.color="var(--tx2)",e.style.borderColor="var(--bd)")):(window._activeChips.add(t),e&&(e.style.background="var(--ac)",e.style.color="#000",e.style.borderColor="var(--ac)")),Ks()}function Ks(){const t=c("recPicker"),e=c("recFilter")?c("recFilter").value.trim().toLowerCase():"",n=[...window._activeChips].map(r=>r.toLowerCase()),s=[...a.recs].sort((r,o)=>(o.cookCount||0)-(r.cookCount||0)).filter(r=>{const o=(r.name+" "+(r.description||"")+" "+(r.tags||[]).join(" ")).toLowerCase(),l=e?e.split(/\s+/).every(u=>o.includes(u)):!0,d=n.every(u=>o.includes(u));return l&&d});t.innerHTML='<option value="">— pick a saved recipe —</option>'+s.map(r=>`<option value="${r.id}">${r.name}</option>`).join(""),window._pickedRec=null,c("mealMinp").value=""}function au(t,e){a.md=t,c("mealMttl").textContent="Meal for "+e,c("mealMinp").value=a.mp[t]||"",window._pickedRec=null,window._activeChips=new Set;const n=c("recFilter");n&&(n.value=""),Gs();const i=c("recPicker");if(a.recs&&a.recs.length){const s=[...a.recs].sort((l,d)=>(d.cookCount||0)-(l.cookCount||0));i.innerHTML='<option value="">— pick a saved recipe —</option>'+s.map(l=>`<option value="${l.id}">${l.name}</option>`).join("");const r=a.mp[t]||"",o=s.find(l=>l.name===r);i.value=o?o.id:"",c("recPickerWrap").style.display="block"}else c("recPickerWrap").style.display="none";c("mealM").classList.add("active"),setTimeout(()=>c("mealMinp").focus(),100)}function cu(t){if(!t){window._pickedRec=null,c("mealMinp").value="";return}const e=a.recs.find(n=>n.id===t);e&&(window._pickedRec=e,c("mealMinp").value=e.name)}function Un(){c("mealM").classList.remove("active")}async function lu(){const t=c("mealMinp").value.trim();if(await Ie(a.md,t||null),window._pickedRec&&window._pickedRec.description){const e=window._pickedRec.description,n=a.inv.map(o=>o.name.toLowerCase()),i=a.shop.map(o=>o.name.toLowerCase()),s=e.split(/[\n,]/).map(o=>o.replace(/^[\d\/\s]*(cup|tbsp|tsp|oz|lb|g|kg|ml|l|clove|slice|piece|bunch|head|can|package|pkg)s?\.?\s*/gi,"").replace(/^[\d]+\s*/,"").trim()).filter(o=>o.length>1&&o.length<60);let r=0;for(const o of s){if(/\b(add|mix|heat|cook|bake|stir|boil|fry|slice|chop|dice|combine|place|pour|season|serve|preheat|bring|remove|let|set|transfer)\b/i.test(o))continue;const l=o.replace(/^[-•*]\s*/,"").trim();if(!l||l.length<2)continue;const d=l.toLowerCase();n.some(u=>u.includes(d)||d.includes(u))||i.some(u=>u===d)||(await ae({id:Date.now().toString()+Math.random().toString(36).slice(2),name:l,qty:1,checked:!1,src:"recipe"}),r++)}r>0&&f(`Added ${r} ingredient${r!==1?"s":""} to shopping list 🛒`)}window._pickedRec=null,Un(),Se(),ct(),Fe()}async function du(){await Ie(a.md,null),Un(),Se(),ct(),Fe()}function uu(t){const e=a.mp[t];e&&(a.cn=e,a.nr=0,c("cookedNm").textContent=e,c("cnotes").value="",Je("cstars",0),c("cookedM").classList.add("active"))}async function hu(){await Rs(a.cn,he()),await Ie(he(),null),c("cookedM").classList.remove("active"),Se(),Fe(),f("Meal logged!")}async function fu(){var i;const t=c("cnotes").value.trim(),e=(i=c("tog-leftover"))==null?void 0:i.classList.contains("on");await Rs(a.cn,he());const n=a.recs.find(s=>s.name.toLowerCase()===a.cn.toLowerCase());n?await ke({...n,cookCount:(n.cookCount||0)+1,lastCooked:he()}):await ke({id:"rec-"+Date.now(),name:a.cn,rating:a.nr,favorited:!1,notes:t,description:"",source:"Meal Plan",tags:[],cookCount:1,savedAt:new Date().toLocaleDateString(),lastCooked:he()}),e&&await Ie(Cl(),a.cn+" (leftovers)"),await Ie(he(),null),c("cookedM").classList.remove("active"),Se(),Fe(),f(e?"Saved! Leftovers planned for tomorrow 🥡":"Saved to recipes! ⭐")}function pu(t){c("schedNm").textContent=t;const e=["S","M","T","W","T","F","S"],n=new Date;n.setHours(0,0,0,0),c("schedWk").innerHTML=He().map((i,s)=>{const r=i.toISOString().split("T")[0],o=i.getTime()===n.getTime(),l=a.mp[r];return`<div class="wd${o?" today":""}${l?" hm":""}" onclick="schedSet('${r}','${t}')"><div class="wdn">${e[s]}</div><div class="wdd">${i.getDate()}</div>${l?`<div class="wdm">${l.substring(0,8)}…</div>`:""}</div>`}).join(""),c("schedM").classList.add("active")}async function mu(t,e){await Ie(t,e),c("schedM").classList.remove("active"),Se(),Fe(),f("Scheduled! 📅")}function gu(){const t=s=>c(s),e=(s,r)=>{const o=t(s);o&&(o.value=r||"")};e("setName",a.cfg.name),e("setAdults",a.cfg.adults),e("setKids",a.cfg.kids),e("setOther",a.cfg.other),e("setCuisines",a.cfg.cuisines),e("setCookTime",a.cfg.cookTime),e("setZipcode",a.cfg.zipcode);const n=(s,r)=>{const o=t(s);o&&o.classList.toggle("on",!!r)};n("tg-nopork",a.cfg.nopork),n("tg-noshellfish",a.cfg.noshellfish),n("tg-vegetarian",a.cfg.vegetarian),n("tg-glutenfree",a.cfg.glutenfree),n("tg-notif",a.cfg.notif);const i=c("notifTimeRow");i&&(i.style.display=a.cfg.notif?"block":"none"),e("setNotifTime",a.cfg.notifTime||"8"),e("setNotifDays",String(a.cfg.notifDays||3)),Fn(),Ys()}async function yu(){a.cfg={...a.cfg,name:c("setName").value.trim(),adults:c("setAdults").value.trim(),kids:c("setKids").value.trim(),nopork:c("tg-nopork").classList.contains("on"),noshellfish:c("tg-noshellfish").classList.contains("on"),vegetarian:c("tg-vegetarian").classList.contains("on"),glutenfree:c("tg-glutenfree").classList.contains("on"),other:c("setOther").value.trim(),cuisines:c("setCuisines").value.trim(),cookTime:c("setCookTime").value,zipcode:c("setZipcode")?c("setZipcode").value.trim():"",notif:c("tg-notif").classList.contains("on"),notifTime:c("setNotifTime")?c("setNotifTime").value:"8",notifDays:parseInt(c("setNotifDays")?c("setNotifDays").value:"3")},await Ls(),a.cfg.notif&&Js(),f("Settings saved!"),L("settings"),Rn()}async function vu(t){if(!t.classList.contains("on")){if(!("Notification"in window)){f("Notifications not supported on this browser");return}if(Notification.permission==="denied"){f("Notifications blocked — enable in browser settings");return}if(Notification.permission!=="granted"&&await Notification.requestPermission()!=="granted"){f("Notifications permission denied");return}}t.classList.toggle("on");const n=c("notifTimeRow");n&&(n.style.display=t.classList.contains("on")?"block":"none")}function wu(){if(Notification.permission!=="granted"){f("Enable notifications first");return}const t=a.inv.filter(n=>{const i=G(n.expiry);return i&&(i.c==="expiring"||i.c==="expired")});if(!t.length){new Notification("Kitchen 🧺",{body:"No items expiring soon — you're all good!"});return}const e=t.slice(0,3).map(n=>n.name).join(", ");new Notification("Kitchen 🧺 — Expiring Soon",{body:`${e}${t.length>3?" + "+(t.length-3)+" more":""} need attention`})}function Js(){if(!a.cfg.notif||Notification.permission!=="granted")return;const t=parseInt(localStorage.getItem("ks-lastnotif")||"0"),e=Date.now();if(e-t<864e5)return;localStorage.setItem("ks-lastnotif",e.toString());const n=a.cfg.notifDays||3,i=a.inv.filter(r=>{if(!G(r.expiry))return!1;const l=new Date(r.expiry+"T00:00:00"),d=new Date;return d.setHours(0,0,0,0),Math.round((l-d)/864e5)<=n});if(!i.length)return;const s=i.slice(0,3).map(r=>r.name).join(", ");new Notification("Kitchen 🧺 — Expiring Soon",{body:`${s}${i.length>3?" + "+(i.length-3)+" more":""} expiring in ${n} days or less`})}function Hn(){return x("ks-hhs")||[a.hid]}async function Ys(){const t=D();if(t)try{const e=await C(`households/${a.hid}`);if(!e)return;const n=e.ownerUid===t.uid,i=c("hhInviteCode");if(i&&(i.textContent=e.inviteCode||"—"),e.inviteCode&&n)try{await w(`household_codes/${e.inviteCode}`,{householdId:a.hid})}catch{}const s=c("regenCodeBtn");s&&(s.style.display=n?"":"none");const r=c("hhMembers");r&&e.members&&(r.innerHTML=e.members.map(o=>{const l=o.uid===t.uid,d=o.role==="owner"?"Owner":"Member",u=n&&!l?`<button onclick="event.stopPropagation();removeMemberFromHH('${o.uid}')" style="background:none;border:none;color:var(--rd);cursor:pointer;font-size:.78rem;padding:4px 8px">Remove</button>`:"";return`<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 12px;background:var(--card);border:1px solid var(--b2);border-radius:10px;margin-bottom:6px">
          <div>
          ...
          ${u}
        </div>`}).join(""))}catch(e){console.error("renderHouseholdInfo error:",e)}}async function bu(){var e;const t=(e=c("hhInviteCode"))==null?void 0:e.textContent;if(!(!t||t==="—"))try{await navigator.clipboard.writeText(t),f("Invite code copied!")}catch{f("Couldn't copy — try manually")}}async function Iu(){var n;const t=(n=c("hhInviteCode"))==null?void 0:n.textContent;if(!t||t==="—")return;const e=`Join my kitchen on Kitchen app! Use invite code: ${t} at https://pantry-app-zeta-six.vercel.app`;if(navigator.share)try{await navigator.share({text:e})}catch{}else try{await navigator.clipboard.writeText(e),f("Share text copied to clipboard!")}catch{f("Couldn't share — try manually")}}async function ku(){if(confirm("Regenerate invite code? The old code will stop working."))try{const t=await hl(a.hid);if(t){const e=c("hhInviteCode");e&&(e.textContent=t),f("New invite code generated!")}}catch(t){console.error("regenInviteCode error:",t),f("Failed to regenerate code")}}async function _u(t){if(confirm("Remove this member from the household?"))try{await fl(a.hid,t),f("Member removed"),Ys()}catch(e){console.error("removeMemberFromHH error:",e),f("Failed to remove member")}}async function Su(){var i,s,r;const t=(r=(s=(i=c("newHHCode"))==null?void 0:i.value)==null?void 0:s.trim())==null?void 0:r.toUpperCase();if(!t)return;const e=D();if(!e){f("Sign in first");return}const n=c("newHHCode");n.disabled=!0;try{const o=await As(t,e);if(!o){f("Invalid invite code. Check and try again."),n.disabled=!1;return}const l=Hn();l.includes(o)||l.push(o),z("ks-hhs",l),c("newHHCode").value="",Fn(),f("Household joined!")}catch(o){console.error("addHousehold error:",o),f("Failed to join household")}n.disabled=!1}function Eu(t){t!==a.hid&&(localStorage.setItem("ks-h",t),location.reload())}async function Cu(t){if(t===a.hid){f("Can't remove active household");return}const e=D();if(e)try{const i=await C(`users/${e.uid}`);if(i){const r=(i.householdIds||[]).filter(o=>o!==t);await w(`users/${e.uid}`,{...i,householdIds:r,id:void 0})}const s=await C(`households/${t}`);if(s){const r=(s.members||[]).filter(l=>l.uid!==e.uid),o=(s.memberUids||[]).filter(l=>l!==e.uid);await w(`households/${t}`,{...s,members:r,memberUids:o,id:void 0})}}catch(i){console.error("removeHousehold error:",i)}const n=Hn().filter(i=>i!==t);z("ks-hhs",n),Fn()}async function Fn(){const t=Hn(),e=c("hhList");if(!e)return;const n=[];for(const i of t){let s=i;try{const r=await C(`households/${i}`);r!=null&&r.name&&(s=r.name)}catch{}n.push({id:i,name:s})}e.innerHTML=n.map(({id:i,name:s})=>{const r=i===a.hid;return`<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 12px;background:var(--card);border:1px solid ${r?"var(--ac)":"var(--b2)"};border-radius:10px;margin-bottom:6px;cursor:pointer" onclick="switchHousehold('${i}')">
      <div>
    ...
    </div>`}).join("")}const xt={gold:{name:"Gold",swatch:"#d4a853",dark:{bg:"#0f0f0d",sf:"#1a1a17",card:"#222220",card2:"#2a2a27",b1:"#333330",b2:"#3d3d39",ac:"#d4a853",ac2:"#e8c27a",acr:"212,168,83",tx:"#ede8d8",tx2:"#b8b09a",mt:"#7a7468"},light:{bg:"#faf8f2",sf:"#ffffff",card:"#f3ede0",card2:"#efe8d8",b1:"#ddd5c0",b2:"#cec4ac",ac:"#a8732a",ac2:"#c48f3e",acr:"168,115,42",tx:"#2a2418",tx2:"#5c5040",mt:"#9a8870"}},forest:{name:"Forest",swatch:"#4a9e5c",dark:{bg:"#0a1410",sf:"#111f17",card:"#182a1e",card2:"#1e3326",b1:"#2a4032",b2:"#355040",ac:"#6db56d",ac2:"#8fd08f",acr:"109,181,109",tx:"#e4f0e4",tx2:"#9dbf9d",mt:"#5a7a5a"},light:{bg:"#f2f9f2",sf:"#ffffff",card:"#e8f5e8",card2:"#dff0df",b1:"#c0ddc0",b2:"#a8cca8",ac:"#2e7d32",ac2:"#43a047",acr:"46,125,50",tx:"#0d2010",tx2:"#2e4f2e",mt:"#5a7a5a"}},ocean:{name:"Ocean",swatch:"#38bdf8",dark:{bg:"#060e1a",sf:"#0d1829",card:"#112035",card2:"#162840",b1:"#1e3554",b2:"#264468",ac:"#38bdf8",ac2:"#7dd3fc",acr:"56,189,248",tx:"#e0f2fe",tx2:"#7ab8d4",mt:"#486880"},light:{bg:"#f0f8ff",sf:"#ffffff",card:"#e0f2fe",card2:"#d4ecf9",b1:"#b0d8f0",b2:"#90c4e4",ac:"#0369a1",ac2:"#0284c7",acr:"3,105,161",tx:"#082040",tx2:"#1e4060",mt:"#4a7090"}},bordeaux:{name:"Bordeaux",swatch:"#e8829a",dark:{bg:"#120810",sf:"#1c0e18",card:"#261420",card2:"#301828",b1:"#4a2238",b2:"#5c2a46",ac:"#e8829a",ac2:"#f4aabb",acr:"232,130,154",tx:"#fce8ee",tx2:"#d4909e",mt:"#8a5060"},light:{bg:"#fff5f7",sf:"#ffffff",card:"#ffe8ed",card2:"#ffd8e0",b1:"#f4b8c4",b2:"#eca0b0",ac:"#be3455",ac2:"#d94070",acr:"190,52,85",tx:"#2a080e",tx2:"#6a2030",mt:"#9a5060"}},sand:{name:"Sand",swatch:"#e07a5f",dark:{bg:"#170e08",sf:"#221508",card:"#2e1c0e",card2:"#382414",b1:"#4a3020",b2:"#5c3c28",ac:"#e07a5f",ac2:"#eca080",acr:"224,122,95",tx:"#fdf0e8",tx2:"#c8a090",mt:"#887060"},light:{bg:"#fdf6ec",sf:"#fffbf5",card:"#f5e8d8",card2:"#eedcc8",b1:"#ddc8ac",b2:"#ccb494",ac:"#c1440e",ac2:"#d4602a",acr:"193,68,14",tx:"#2a1808",tx2:"#5c3820",mt:"#9a7060"}},midnight:{name:"Midnight",swatch:"#818cf8",dark:{bg:"#050814",sf:"#0a0d1f",card:"#0f1228",card2:"#141830",b1:"#1e2448",b2:"#272e58",ac:"#818cf8",ac2:"#a5b0ff",acr:"129,140,248",tx:"#e8eaff",tx2:"#9099cc",mt:"#505880"},light:{bg:"#f0f1ff",sf:"#ffffff",card:"#e4e6ff",card2:"#d8dbff",b1:"#b8bdff",b2:"#a0a6f4",ac:"#4f46e5",ac2:"#6366f1",acr:"79,70,229",tx:"#0a0820",tx2:"#202060",mt:"#5050a0"}},lavender:{name:"Lavender",swatch:"#c084fc",dark:{bg:"#0e0814",sf:"#160e20",card:"#1e1430",card2:"#261a3c",b1:"#382454",b2:"#442c66",ac:"#c084fc",ac2:"#d8a8ff",acr:"192,132,252",tx:"#f5ecff",tx2:"#c0a0e0",mt:"#7a5898"},light:{bg:"#faf5ff",sf:"#ffffff",card:"#f3e8ff",card2:"#ecdcff",b1:"#d8b8f8",b2:"#c8a0f0",ac:"#9333ea",ac2:"#a855f7",acr:"147,51,234",tx:"#1a0830",tx2:"#481080",mt:"#805098"}}};let et=x("ks-theme")||"gold",tt=x("ks-mode")||"auto";function At(t,e){et=t,tt=e,z("ks-theme",t),z("ks-mode",e);const n=xt[t]||xt.gold,s=e==="dark"||e==="auto"&&window.matchMedia("(prefers-color-scheme: dark)").matches?n.dark:n.light,r=document.documentElement.style;r.setProperty("--bg",s.bg),r.setProperty("--sf",s.sf),r.setProperty("--card",s.card),r.setProperty("--card2",s.card2),r.setProperty("--b1",s.b1),r.setProperty("--b2",s.b2),r.setProperty("--ac",s.ac),r.setProperty("--ac2",s.ac2),r.setProperty("--acd","rgba("+s.acr+",.12)"),r.setProperty("--tx",s.tx),r.setProperty("--tx2",s.tx2),r.setProperty("--mt",s.mt),r.setProperty("--gn","#6db56d"),r.setProperty("--gnd","rgba(109,181,109,.12)"),r.setProperty("--rd","#d96b6b"),r.setProperty("--rdd","rgba(217,107,107,.12)"),r.setProperty("--am","#c8960a"),r.setProperty("--amd","rgba(200,150,10,.12)"),Qs(e),Xs(t)}function Tu(t){At(et,t)}function Qs(t){["auto","light","dark"].forEach(e=>{const n=c("mode-"+e);n&&(n.style.background=e===t?"var(--ac)":"",n.style.color=e===t?"var(--bg)":"",n.style.borderColor=e===t?"var(--ac)":"")})}function Xs(t){const e=c("themePicker");e&&(e.innerHTML="",Object.keys(xt).forEach(n=>{const i=xt[n],s=n===t,r=document.createElement("div");r.title=i.name,r.style.cssText="width:36px;height:36px;border-radius:50%;background:"+i.swatch+";cursor:pointer;border:3px solid "+(s?"var(--tx)":"transparent")+";box-shadow:"+(s?"0 0 0 2px var(--ac)":"none")+";transition:all .2s;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:.85rem",r.textContent=s?"✓":"",r.onclick=()=>At(n,tt),r.onmouseover=function(){this.style.transform="scale(1.15)"},r.onmouseout=function(){this.style.transform="scale(1)"},e.appendChild(r)}))}function xu(){At(et,tt),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{tt==="auto"&&At(et,"auto")})}function Au(){Xs(et),Qs(tt)}window.getIdToken=Cs;y.renderAll=Ps;y.renderSum=ct;y.renderRecs=Ut;y.renderShop=lt;Ll($n);window.showScreen=function(t){var e,n;document.querySelectorAll(".ov.active").forEach(i=>i.classList.remove("active")),document.querySelectorAll(".screen").forEach(i=>i.classList.remove("active")),document.querySelectorAll(".ni").forEach(i=>i.classList.remove("active")),(e=c("screen-"+t))==null||e.classList.add("active"),(n=c("nav-"+t))==null||n.classList.add("active"),t==="home"&&Ds(),t==="inventory"&&$n(),t==="recipes"&&(a.rt==="community"?Nn():Ut()),t==="shopping"&&lt(),t==="insights"&&Pd()};const Lu=ye;window.showOv=function(t){Lu(t),t==="settings"&&setTimeout(Au,80)};window.hideOv=L;window.initHome=Rn;window.toggleExp=function(){const t=c("exppanel");t.style.display=t.style.display==="none"?"block":"none"};window.openAdj=Pl;window.updL=Dl;window.adjQ=Nl;window.adjQD=Ml;window.adjE=Ol;window.adjNote=Ul;window.setIT=Hl;window.addManual=Fl;window.valMA=jl;window.chgMQ=Bl;window.selML=zl;window.remItem=Pn;window.importDoc=ql;window.qadd=Ms;window.togShop=Gl;window.toggleShNote=Kl;window.saveShNote=Jl;window.openShQty=Yl;window.adjShQty=Ql;window.saveShQty=Us;window.togAisle=Xl;window.setSHT=Zl;window.shareList=ed;window.openAddToKitchen=td;window.setAtkLoc=nd;window.confirmAddToKitchen=id;window.buildList=sd;window.toggleVoice=Wl;window.bpTog=rd;window.bpSelAll=od;window.bpUpdBtn=function(){};window.bpConfirm=ad;window._bpItems=[];window.searchDeals=cd;window.dealsFromList=ld;window.addDealToList=Fs;window.renderDealsZipBanner=Hs;window.clrChk=function(){a.shop.filter(t=>t.checked).forEach(t=>{Os(t.name),Ot(t.id)})};window.setRT=fd;window.togFav=pd;window.valR=md;window.importFromUrl=gd;window.saveRec=yd;window.openER=vd;window.updR=wd;window.delER=bd;window.scaleRec=Id;window.whatCanIMake=kd;window.addRecIngToShop=_d;window.setStar=Sd;window.togTag=ud;window.togglePublic=Ed;window.loadCommunity=Nn;window.setComCuisine=Cd;window.setComSearch=Td;window.openComRecipe=xd;window.likeComRecipe=Ad;window.saveComToKitchen=Ld;window.addComComment=Rd;window.shareComRecipe=$d;window.sendChat=Bs;window.sendPill=Md;window.clrChat=Od;window.ar=zs;window.startScan=Fd;window.openScanForList=jd;window.openScanForInventory=Bd;window.addScannedToList=zd;window.togManual=qd;window.handlePhoto=Vd;window.manLookup=Wd;window.selRL=On;window.valAdd=Yd;window.addToInv=Qd;window.chgAQ=Xd;window.swipeDelItem=eu;window.swipeRowTap=tu;window.togShopSelect=nu;window.togInvSelect=iu;window.cancelSelect=De;window.deleteSelected=su;window.openMealM=au;window.pickRec=cu;window.closeMealM=Un;window.saveMeal=lu;window.clrMeal=du;window.openCooked=uu;window.skipCooked=hu;window.saveCooked=fu;window.scheduleRecipe=pu;window.schedSet=mu;window.initRecChips=Gs;window.toggleChip=ou;window.filterRecs=Ks;window._pickedRec=null;window._activeChips=new Set;window.saveSettings=yu;window.toggleNotif=vu;window.testNotif=wu;window.addHousehold=Su;window.switchHousehold=Eu;window.removeHousehold=Cu;window.setMode=Tu;window.showNotif=f;window.copyInviteCode=bu;window.shareInviteCode=Iu;window.regenInviteCode=ku;window.removeMemberFromHH=_u;window._appStart=async function(t){var s;a.hid=t,c("LS").style.display="none",c("APP").style.display="flex",window.showScreen("home"),q("syncing");const e=D();if(e)try{const r=await C(`users/${e.uid}`);if((s=r==null?void 0:r.householdIds)!=null&&s.length){const o=[...r.householdIds];o.includes(t)||o.push(t),z("ks-hhs",o)}else{const o=x("ks-hhs")||[t];o.includes(t)||(o.push(t),z("ks-hhs",o))}}catch{const r=x("ks-hhs")||[t];r.includes(t)||(r.push(t),z("ks-hhs",r))}else{const r=x("ks-hhs")||[t];r.includes(t)||(r.push(t),z("ks-hhs",r))}await gl(),gu(),Rn(),Vl();async function n(){try{q("syncing");const r=await Promise.allSettled([T(`households/${a.hid}/inventory`),T(`households/${a.hid}/recipes`),T(`households/${a.hid}/shopping`),T(`households/${a.hid}/mealplan`),T(`households/${a.hid}/settings`),T(`households/${a.hid}/cooklog`),T(`households/${a.hid}/wastelog`)]),o=(v,_)=>v.status==="fulfilled"?v.value:_;a.inv=o(r[0],a.inv),a.recs=o(r[1],a.recs),a.shop=o(r[2],a.shop);const l=o(r[3],[]),d=o(r[4],[]),u=o(r[5],[]),h=o(r[6],[]),m={};l.forEach(v=>{v.date&&v.meal&&(m[v.date]=v.meal)}),a.mp=m;const p=d.find(v=>v.id==="config");p&&(a.cfg={...wt,...p}),a.cookLog=u.sort((v,_)=>new Date(_.loggedAt||_.date||0)-new Date(v.loggedAt||v.date||0)),a.wasteLog=h.sort((v,_)=>new Date(_.loggedAt||_.date||0)-new Date(v.loggedAt||v.date||0)),q("synced"),Ps(),Ut(),lt(),ct()}catch(r){console.error("poll error",r),q("error")}}window._poll=n,n();const i=setInterval(n,3e4);window._pollFn=n,window._pollIntervalId=i};xu();Zd();a.cfg.notif&&setTimeout(Js,3e3);lt();function Ft(t){c("auth-loading").style.display="none",c("auth-signin").style.display=t==="signin"?"flex":"none",c("auth-signup").style.display=t==="signup"?"flex":"none",c("auth-join").style.display=t==="join"?"flex":"none",c("authError").style.display="none",c("signupError").style.display="none"}function j(t,e){const n=c(t);n&&(n.textContent=e,n.style.display="block")}function jt(t){return{"auth/invalid-email":"Please enter a valid email address.","auth/user-disabled":"This account has been disabled.","auth/user-not-found":"No account found with this email.","auth/wrong-password":"Incorrect password.","auth/invalid-credential":"Incorrect email or password.","auth/email-already-in-use":"An account with this email already exists.","auth/weak-password":"Password must be at least 6 characters.","auth/too-many-requests":"Too many attempts. Please try again later.","auth/popup-closed-by-user":"Sign-in popup was closed.","auth/cancelled-popup-request":"Sign-in was cancelled.","auth/account-exists-with-different-credential":"An account already exists with this email using a different sign-in method."}[t.code]||t.message||"Something went wrong. Please try again."}function P(t,e){t&&(e?(t._origText=t.textContent,t.textContent="Please wait…",t.disabled=!0):(t.textContent=t._origText||t.textContent,t.disabled=!1))}var Ii;(Ii=c("btnGoogle"))==null||Ii.addEventListener("click",async()=>{const t=c("btnGoogle");P(t,!0),c("authError").style.display="none";try{await ol()}catch(e){j("authError",jt(e))}P(t,!1)});var ki;(ki=c("btnApple"))==null||ki.addEventListener("click",async()=>{const t=c("btnApple");P(t,!0),c("authError").style.display="none";try{await al()}catch(e){j("authError",jt(e))}P(t,!1)});var _i;(_i=c("btnEmailSign"))==null||_i.addEventListener("click",async()=>{var i,s,r;const t=(s=(i=c("authEmail"))==null?void 0:i.value)==null?void 0:s.trim(),e=(r=c("authPass"))==null?void 0:r.value;if(!t||!e){j("authError","Please enter your email and password.");return}const n=c("btnEmailSign");P(n,!0),c("authError").style.display="none";try{await cl(t,e)}catch(o){j("authError",jt(o))}P(n,!1)});var Si;(Si=c("btnEmailSignup"))==null||Si.addEventListener("click",async()=>{var s,r,o,l,d;const t=(r=(s=c("signupName"))==null?void 0:s.value)==null?void 0:r.trim(),e=(l=(o=c("signupEmail"))==null?void 0:o.value)==null?void 0:l.trim(),n=(d=c("signupPass"))==null?void 0:d.value;if(!t){j("signupError","Please enter your name.");return}if(!e||!n){j("signupError","Please enter your email and password.");return}const i=c("btnEmailSignup");P(i,!0),c("signupError").style.display="none";try{await ll(e,n,t)}catch(u){j("signupError",jt(u))}P(i,!1)});var Ei;(Ei=c("btnToggleSignup"))==null||Ei.addEventListener("click",()=>Ft("signup"));var Ci;(Ci=c("btnToggleSignin"))==null||Ci.addEventListener("click",()=>Ft("signin"));var Ti;(Ti=c("authPass"))==null||Ti.addEventListener("keydown",t=>{var e;t.key==="Enter"&&((e=c("btnEmailSign"))==null||e.click())});var xi;(xi=c("signupPass"))==null||xi.addEventListener("keydown",t=>{var e;t.key==="Enter"&&((e=c("btnEmailSignup"))==null||e.click())});window.doSignOut=async function(){confirm("Sign out of Kitchen?")&&await dl()};let Xt=!1;function Lt(t){localStorage.setItem("ks-h",t),c("LS").style.display="none",c("APP").style.display="flex",window._appStart(t)}function Ru(t){Ft("join"),c("btnCreateKitchen").onclick=async()=>{var e;P(c("btnCreateKitchen"),!0);try{const n=((e=a.cfg)==null?void 0:e.name)||"My Kitchen";await xs(t.uid,n);const i=await ln(t);i.householdIds=[t.uid],await w(`users/${t.uid}`,i),localStorage.removeItem("ks-h");const s=x("ks-hhs");if(s){const r=s.filter(o=>o!==t.uid);r.push(t.uid),localStorage.setItem("ks-hhs",JSON.stringify(r))}Lt(t.uid)}catch(n){console.error("Create kitchen error:",n),j("joinError","Something went wrong. Please try again."),P(c("btnCreateKitchen"),!1)}},c("btnJoinKitchen").onclick=async()=>{var n,i,s;const e=(s=(i=(n=c("joinCode"))==null?void 0:n.value)==null?void 0:i.trim())==null?void 0:s.toUpperCase();if(!e){j("joinError","Please enter an invite code.");return}P(c("btnJoinKitchen"),!0),c("joinError").style.display="none";try{let r=await C(`users/${t.uid}`);r||(r=await ln(t));const o=await As(e,t);if(!o){j("joinError","Invalid invite code. Check and try again."),P(c("btnJoinKitchen"),!1);return}const l=x("ks-hhs")||[];l.includes(o)||l.push(o),z("ks-hhs",l),Lt(o)}catch(r){console.error("Join kitchen error:",r),j("joinError","Something went wrong. Please try again."),P(c("btnJoinKitchen"),!1)}}}sl(async t=>{var e;if(t){if(localStorage.setItem("ks-who",t.displayName||((e=t.email)==null?void 0:e.split("@")[0])||"You"),!Xt){Xt=!0;try{const n=await C(`users/${t.uid}`),i=localStorage.getItem("ks-h"),s=x("ks-hhs");if(!!n||!!i||s&&s.length>0){c("LS").style.display="none",c("APP").style.display="flex";const o=await pl(t);Lt(o)}else Ru(t)}catch(n){console.error("Failed to resolve household:",n);const i=t.uid;Lt(i)}}}else Xt=!1,c("APP").style.display="none",c("LS").style.display="flex",Ft("signin")});
