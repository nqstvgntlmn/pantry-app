 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oh(n,e){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},i=e||"demo-project",s=n.iat||0,r=n.sub||n.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o={iss:`https://securetoken.google.com/${i}`,aud:i,iat:s,exp:s+3600,auth_time:s,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}},...n};return[gr(JSON.stringify(t)),gr(JSON.stringify(o)),""].join(".")}const zi={};function Gm(){const n={prod:[],emulator:[]};for(const e of Object.keys(zi))zi[e]?n.emulator.push(e):n.prod.push(e);return n}function Km(n){let e=document.getElementById(n),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",n),t=!0),{created:t,element:e}}let eu=!1;function Ha(n,e){if(typeof window>"u"||typeof document>"u"||!sn(window.location.host)||zi[n]===e||zi[n]||eu)return;zi[n]=e;function t(b){return`__firebase__banner__${b}`}const i="__firebase__banner",r=Gm().prod.length>0;function o(){const b=document.getElementById(i);b&&b.remove()}function c(b){b.style.display="flex",b.style.background="#7faaf0",b.style.position="fixed",b.style.bottom="5px",b.style.left="5px",b.style.padding=".5em",b.style.borderRadius="5px",b.style.alignItems="center"}function u(b,C){b.setAttribute("width","24"),b.setAttribute("id",C),b.setAttribute("height","24"),b.setAttribute("viewBox","0 0 24 24"),b.setAttribute("fill","none"),b.style.marginLeft="-6px"}function h(){const b=document.createElement("span");return b.style.cursor="pointer",b.style.marginLeft="16px",b.style.fontSize="24px",b.innerHTML=" &times;",b.onclick=()=>{eu=!0,o()},b}function m(b,C){b.setAttribute("id",C),b.innerText="Learn more",b.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",b.setAttribute("target","__blank"),b.style.paddingLeft="5px",b.style.textDecoration="underline"}function v(){const b=Km(i),C=t("text"),L=document.getElementById(C)||document.createElement("span"),M=t("learnmore"),N=document.getElementById(M)||document.createElement("a"),z=t("preprendIcon"),G=document.getElementById(z)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(b.created){const V=b.element;c(V),m(N,M);const B=h();u(G,z),V.append(G,L,N,B),document.body.appendChild(V)}r?(L.innerText="Preview backend disconnected.",G.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
...
*/var zt,tf;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,y){function _(){}_.prototype=y.prototype,T.F=y.prototype,T.prototype=new _,T.prototype.constructor=T,T.D=function(E,I,A){for(var w=Array(arguments.length-2),Be=2;Be<arguments.length;Be++)w[Be-2]=arguments[Be];return y.prototype[I].apply(E,w)}}function t(){this.blockSize=-1}function i(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(i,t),i.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,y,_){_||(_=0);const E=Array(16);if(typeof y=="string")for(var I=0;I<16;++I)E[I]=y.charCodeAt(_++)|y.charCodeAt(_++)<<8|y.charCodeAt(_++)<<16|y.charCodeAt(_++)<<24;else for(I=0;I<16;++I)E[I]=y[_++]|y[_++]<<8|y[_++]<<16|y[_++]<<24;y=T.g[0],_=T.g[1],I=T.g[2];let A=T.g[3],w;w=y+(A^_&(I^A))+E[0]+3614090360&4294967295,y=_+(w<<7&4294967295|w>>>25),w=A+(I^y&(_^I))+E[1]+3905402710&4294967295,A=y+(w<<12&4294967295|w>>>20),w=I+(_^A&(y^_))+E[2]+606105819&4294967295,I=A+(w<<17&4294967295|w>>>15),w=_+(y^I&(A^y))+E[3]+3250441966&4294967295,_=I+(w<<22&4294967295|w>>>10),w=y+(A^_&(I^A))+E[4]+4118548399&4294967295,y=_+(w<<7&4294967295|w>>>25),w=A+(I^y&(_^I))+E[5]+1200080426&4294967295,A=y+(w<<12&4294967295|w>>>20),w=I+(_^A&(y^_))+E[6]+2821735955&4294967295,I=A+(w<<17&4294967295|w>>>15),w=_+(y^I&(A^y))+E[7]+4249261313&4294967295,_=I+(w<<22&4294967295|w>>>10),w=y+(A^_&(I^A))+E[8]+1770035416&4294967295,y=_+(w<<7&4294967295|w>>>25),w=A+(I^y&(_^I))+E[9]+2336552879&4294967295,A=y+(w<<12&4294967295|w>>>20),w=I+(_^A&(y^_))+E[10]+4294925233&4294967295,I=A+(w<<17&4294967295|w>>>15),w=_+(y^I&(A^y))+E[11]+2304563134&4294967295,_=I+(w<<22&4294967295|w>>>10),w=y+(A^_&(I^A))+E[12]+1804603682&4294967295,y=_+(w<<7&4294967295|w>>>25),w=A+(I^y&(_^I))+E[13]+4254626195&4294967295,A=y+(w<<12&4294967295|w>>>20),w=I+(_^A&(y^_))+E[14]+2792965006&4294967295,I=A+(w<<17&4294967295|w>>>15),w=_+(y^I&(A^y))+E[15]+1236535329&4294967295,_=I+(w<<22&4294967295|w>>>10),w=y+(I^A&(_^I))+E[1]+4129170786&4294967295,y=_+(w<<5&4294967295|w>>>27),w=A+(_^I&(y^_))+E[6]+3225465664&4294967295,A=y+(w<<9&4294967295|w>>>23),w=I+(y^_&(A^y))+E[11]+643717713&4294967295,I=A+(w<<14&4294967295|w>>>18),w=_+(A^y&(I^A))+E[0]+3921069994&4294967295,_=I+(w<<20&4294967295|w>>>12),w=y+(I^A&(_^I))+E[5]+3593408605&4294967295,y=_+(w<<5&4294967295|w>>>27),w=A+(_^I&(y^_))+E[10]+38016083&4294967295,A=y+(w<<9&4294967295|w>>>23),w=I+(y^_&(A^y))+E[15]+3634488961&4294967295,I=A+(w<<14&4294967295|w>>>18),w=_+(A^y&(I^A))+E[4]+3889429448&4294967295,_=I+(w<<20&4294967295|w>>>12),w=y+(I^A&(_^I))+E[9]+568446438&4294967295,y=_+(w<<5&4294967295|w>>>27),w=A+(_^I&(y^_))+E[14]+3275163606&4294967295,A=y+(w<<9&4294967295|w>>>23),w=I+(y^_&(A^y))+E[3]+4107603335&4294967295,I=A+(w<<14&4294967295|w>>>18),w=_+(A^y&(I^A))+E[8]+1163531501&4294967295,_=I+(w<<20&4294967295|w>>>12),w=y+(I^A&(_^I))+E[13]+2850285829&4294967295,y=_+(w<<5&4294967295|w>>>27),w=A+(_^I&(y^_))+E[2]+4243563512&4294967295,A=y+(w<<9&4294967295|w>>>23),w=I+(y^_&(A^y))+E[7]+1735328473&4294967295,I=A+(w<<14&4294967295|w>>>18),w=_+(A^y&(I^A))+E[12]+2368359562&4294967295,_=I+(w<<20&4294967295|w>>>12),w=y+(_^I^A)+E[5]+4294588738&4294967295,y=_+(w<<4&4294967295|w>>>28),w=A+(y^_^I)+E[8]+2272392833&4294967295,A=y+(w<<11&4294967295|w>>>21),w=I+(A^y^_)+E[11]+1839030562&4294967295,I=A+(w<<16&4294967295|w>>>16),w=_+(I^A^y)+E[14]+4259657740&4294967295,_=I+(w<<23&4294967295|w>>>9),w=y+(_^I^A)+E[1]+2763975236&4294967295,y=_+(w<<4&4294967295|w>>>28),w=A+(y^_^I)+E[4]+1272893353&4294967295,A=y+(w<<11&4294967295|w>>>21),w=I+(A^y^_)+E[7]+4139469664&4294967295,I=A+(w<<16&4294967295|w>>>16),w=_+(I^A^y)+E[10]+3200236656&4294967295,_=I+(w<<23&4294967295|w>>>9),w=y+(_^I^A)+E[13]+681279174&4294967295,y=_+(w<<4&4294967295|w>>>28),w=A+(y^_^I)+E[0]+3936430074&4294967295,A=y+(w<<11&4294967295|w>>>21),w=I+(A^y^_)+E[3]+3572445317&4294967295,I=A+(w<<16&4294967295|w>>>16),w=_+(I^A^y)+E[6]+76029189&4294967295,_=I+(w<<23&4294967295|w>>>9),w=y+(_^I^A)+E[9]+3654602809&4294967295,y=_+(w<<4&4294967295|w>>>28),w=A+(y^_^I)+E[12]+3873151461&4294967295,A=y+(w<<11&4294967295|w>>>21),w=I+(A^y^_)+E[15]+530742520&4294967295,I=A+(w<<16&4294967295|w>>>16),w=_+(I^A^y)+E[2]+3299628645&4294967295,_=I+(w<<23&4294967295|w>>>9),w=y+(I^(_|~A))+E[0]+4096336452&4294967295,y=_+(w<<6&4294967295|w>>>26),w=A+(_^(y|~I))+E[7]+1126891415&4294967295,A=y+(w<<10&4294967295|w>>>22),w=I+(y^(A|~_))+E[14]+2878612391&4294967295,I=A+(w<<15&4294967295|w>>>17),w=_+(A^(I|~y))+E[5]+4237533241&4294967295,_=I+(w<<21&4294967295|w>>>11),w=y+(I^(_|~A))+E[12]+1700485571&4294967295,y=_+(w<<6&4294967295|w>>>26),w=A+(_^(y|~I))+E[3]+2399980690&4294967295,A=y+(w<<10&4294967295|w>>>22),w=I+(y^(A|~_))+E[10]+4293915773&4294967295,I=A+(w<<15&4294967295|w>>>17),w=_+(A^(I|~y))+E[1]+2240044497&4294967295,_=I+(w<<21&4294967295|w>>>11),w=y+(I^(_|~A))+E[8]+1873313359&4294967295,y=_+(w<<6&4294967295|w>>>26),w=A+(_^(y|~I))+E[15]+4264355552&4294967295,A=y+(w<<10&4294967295|w>>>22),w=I+(y^(A|~_))+E[6]+2734768916&4294967295,I=A+(w<<15&4294967295|w>>>17),w=_+(A^(I|~y))+E[13]+1309151649&4294967295,_=I+(w<<21&4294967295|w>>>11),w=y+(I^(_|~A))+E[4]+4149444226&4294967295,y=_+(w<<6&4294967295|w>>>26),w=A+(_^(y|~I))+E[11]+3174756917&4294967295,A=y+(w<<10&4294967295|w>>>22),w=I+(y^(A|~_))+E[2]+718787259&4294967295,I=A+(w<<15&4294967295|w>>>17),w=_+(A^(I|~y))+E[9]+3951481745&4294967295,T.g[0]=T.g[0]+y&4294967295,T.g[1]=T.g[1]+(I+(w<<21&4294967295|w>>>11))&4294967295,T.g[2]=T.g[2]+I&4294967295,T.g[3]=T.g[3]+A&4294967295}i.prototype.v=function(T,y){y===void 0&&(y=T.length);const _=y-this.blockSize,E=this.C;let I=this.h,A=0;for(;A<y;){if(I==0)for(;A<=_;)s(this,T,A),A+=this.blockSize;if(typeof T=="string"){for(;A<y;)if(E[I++]=T.charCodeAt(A++),I==this.blockSize){s(this,E),I=0;break}}else for(;A<y;)if(E[I++]=T[A++],I==this.blockSize){s(this,E),I=0;break}}this.h=I,this.o+=y},i.prototype.A=function(){var T=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);T[0]=128;for(var y=1;y<T.length-8;++y)T[y]=0;y=this.o*8;for(var _=T.length-8;_<T.length;++_)T[_]=y&255,y/=256;for(this.v(T),T=Array(16),y=0,_=0;_<4;++_)for(let E=0;E<32;E+=8)T[y++]=this.g[_]>>>E&255;return T};function r(T,y){var _=c;return Object.prototype.hasOwnProperty.call(_,T)?_[T]:_[T]=y(T)}function o(T,y){this.h=y;const _=[];let E=!0;for(let I=T.length-1;I>=0;I--){const A=T[I]|0;E&&A==y||(_[I]=A,E=!1)}this.g=_}var c={};function u(T){return-128<=T&&T<128?r(T,function(y){return new o([y|0],y<0?-1:0)}):new o([T|0],T<0?-1:0)}function h(T){if(isNaN(T)||!isFinite(T))return v;if(T<0)return N(h(-T));const y=[];let _=1;for(let E=0;T>=_;E++)y[E]=T/_|0,_*=4294967296;return new o(y,0)}function m(T,y){if(T.length==0)throw Error("number format error: empty string");if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(T.charAt(0)=="-")return N(m(T.substring(1),y));if(T.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=h(Math.pow(y,8));let E=v;for(let A=0;A<T.length;A+=8){var I=Math.min(8,T.length-A);const w=parseInt(T.substring(A,A+I),y);I<8?(I=h(Math.pow(y,I)),E=E.j(I).add(h(w))):(E=E.j(_),E=E.add(h(w)))}return E}var v=u(0),b=u(1),C=u(16777216);n=o.prototype,n.m=function(){if(M(this))return-N(this).m();let T=0,y=1;for(let _=0;_<this.g.length;_++){const E=this.i(_);T+=(E>=0?E:4294967296+E)*y,y*=4294967296}return T},n.toString=function(T){if(T=T||10,T<2||36<T)throw Error("radix out of range: "+T);if(L(this))return"0";if(M(this))return"-"+N(this).toString(T);const y=h(Math.pow(T,6));var _=this;let E="";for(;;){const I=B(_,y).g;_=z(_,I.j(y));let A=((_.g.length>0?_.g[0]:_.h)>>>0).toString(T);if(_=I,L(_))return A+E;for(;A.length<6;)A="0"+A;E=A+E}},n.i=function(T){return T<0?0:T<this.g.length?this.g[T]:this.h};function L(T){if(T.h!=0)return!1;for(let y=0;y<T.g.length;y++)if(T.g[y]!=0)return!1;return!0}function M(T){return T.h==-1}n.l=function(T){return T=z(this,T),M(T)?-1:L(T)?0:1};function N(T){const y=T.g.length,_=[];for(let E=0;E<y;E++)_[E]=~T.g[E];return new o(_,~T.h).add(b)}n.abs=function(){return M(this)?N(this):this},n.add=function(T){const y=Math.max(this.g.length,T.g.length),_=[];let E=0;for(let I=0;I<=y;I++){let A=E+(this.i(I)&65535)+(T.i(I)&65535),w=(A>>>16)+(this.i(I)>>>16)+(T.i(I)>>>16);E=w>>>16,A&=65535,w&=65535,_[I]=w<<16|A}return new o(_,_[_.length-1]&-2147483648?-1:0)};function z(T,y){return T.add(N(y))}n.j=function(T){if(L(this)||L(T))return v;if(M(this))return M(T)?N(this).j(N(T)):N(N(this).j(T));if(M(T))return N(this.j(N(T)));if(this.l(C)<0&&T.l(C)<0)return h(this.m()*T.m());const y=this.g.length+T.g.length,_=[];for(var E=0;E<2*y;E++)_[E]=0;for(E=0;E<this.g.length;E++)for(let I=0;I<T.g.length;I++){const A=this.i(E)>>>16,w=this.i(E)&65535,Be=T.i(I)>>>16,cn=T.i(I)&65535;_[2*E+2*I]+=w*cn,G(_,2*E+2*I),_[2*E+2*I+1]+=A*cn,G(_,2*E+2*I+1),_[2*E+2*I+1]+=w*Be,G(_,2*E+2*I+1),_[2*E+2*I+2]+=A*Be,G(_,2*E+2*I+2)}for(T=0;T<y;T++)_[T]=_[2*T+1]<<16|_[2*T];for(T=y;T<2*y;T++)_[T]=0;return new o(_,0)};function G(T,y){for(;(T[y]&65535)!=T[y];)T[y+1]+=T[y]>>>16,T[y]&=65535,y++}function V(T,y){this.g=T,this.h=y}function B(T,y){if(L(y))throw Error("division by zero");if(L(T))return new V(v,v);if(M(T))return y=B(N(T),y),new V(N(y.g),N(y.h));if(M(y))return y=B(T,N(y)),new V(N(y.g),y.h);if(T.g.length>30){if(M(T)||M(y))throw Error("slowDivide_ only works with positive integers.");for(var _=b,E=y;E.l(T)<=0;)_=Q(_),E=Q(E);var I=te(_,1),A=te(E,1);for(E=te(E,2),_=te(_,2);!L(E);){var w=A.add(E);w.l(T)<=0&&(I=I.add(_),A=w),E=te(E,1),_=te(_,1)}return y=z(T,I.j(y)),new V(I,y)}for(I=v;T.l(y)>=0;){for(_=Math.max(1,Math.floor(T.m()/y.m())),E=Math.ceil(Math.log(_)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),A=h(_),w=A.j(y);M(w)||w.l(T)>0;)_-=E,A=h(_),w=A.j(y);L(A)&&(A=b),I=I.add(A),T=z(T,w)}return new V(I,T)}n.B=function(T){return B(this,T).h},n.and=function(T){const y=Math.max(this.g.length,T.g.length),_=[];for(let E=0;E<y;E++)_[E]=this.i(E)&T.i(E);return new o(_,this.h&T.h)},n.or=function(T){const y=Math.max(this.g.length,T.g.length),_=[];for(let E=0;E<y;E++)_[E]=this.i(E)|T.i(E);return new o(_,this.h|T.h)},n.xor=function(T){const y=Math.max(this.g.length,T.g.length),_=[];for(let E=0;E<y;E++)_[E]=this.i(E)^T.i(E);return new o(_,this.h^T.h)};function Q(T){const y=T.g.length+1,_=[];for(let E=0;E<y;E++)_[E]=T.i(E)<<1|T.i(E-1)>>>31;return new o(_,T.h)}function te(T,y){const _=y>>5;y%=32;const E=T.g.length-_,I=[];for(let A=0;A<E;A++)I[A]=y>0?T.i(A+_)>>>y|T.i(A+_+1)<<32-y:T.i(A+_);return new o(I,T.h)}i.prototype.digest=i.prototype.A,i.prototype.reset=i.prototype.u,i.prototype.update=i.prototype.v,tf=i,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=m,zt=o}).apply(typeof xu<"u"?xu:typeof self<"u"?self:typeof window<"u"?window:{});var Hs=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let i;try{i=We.makeFromUrl(e,t)}catch{return new We(e,"")}if(i.path==="")return i;throw $I(e)}static makeFromUrl(e,t){let i=null;const s="([A-Za-z0-9.\\-_]+)";function r(B){B.path.charAt(B.path.length-1)==="/"&&(B.path_=B.path_.slice(0,-1))}const o="(/(.*))?$",c=new RegExp("^gs://"+s+o,"i"),u={bucket:1,path:3};function h(B){B.path_=decodeURIComponent(B.path)}const m="v[A-Za-z0-9_]+",v=t.replace(/[.]/g,"\\."),b="(/([^?#]*).*)?$",C=new RegExp(`^https?://${v}/${m}/b/${s}/o${b}`,"i"),L={bucket:1,path:3},M=t===fp?"(?:storage.googleapis.com|storage.cloud.google.com)":t,N="([^?#]*)",z=new RegExp(`^https?://${M}/${s}/${N}`,"i"),V=[{regex:c,indices:u,postModify:r},{regex:C,indices:L,postModify:h},{regex:z,indices:{bucket:1,path:2},postModify:h}];for(let B=0;B<V.length;B++){const Q=V[B],te=Q.regex.exec(e);if(te){const T=te[Q.indices.bucket];let y=te[Q.indices.path];y||(y=""),i=new We(T,y),Q.postModify(i);break}}if(i==null)throw VI(e);return i}}class qI{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zI(n,e,t){let i=1,s=null,r=null,o=!1,c=0;function u(){return c===2}let h=!1;function m(...N){h||(h=!0,e.apply(null,N))}function v(N){s=setTimeout(()=>{s=null,n(C,u())},N)}function b(){r&&clearTimeout(r)}function C(N,...z){if(h){b();return}if(N){b(),m.call(null,N,...z);return}if(u()||o){b(),m.call(null,N,...z);return}i<64&&(i*=2);let V;c===1?(c=2,V=0):V=(i+Math.random())*1e3,v(V)}let L=!1;function M(N){L||(L=!0,b(),!h&&(s!==null?(N||(c=2),clearTimeout(s),v(0)):N||(c=1)))}return v(0),r=setTimeout(()=>{o=!0,M(!0)},t),M}function WI(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Rp="storage";function OE(n,e,t){return n=Ae(n),CE(n,e,t)}function ME(n){return n=Ae(n),RE(n)}function VE(n,e){return n=Ae(n),LE(n,e)}function $E(n=Wa(),e){n=Ae(n);const i=Vr(n,Rp).getImmediate({identifier:e}),s=ih("storage");return s&&UE(i,...s),i}function UE(n,e,t,i={}){NE(n,e,t,i)}function FE(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Mc(t,i,s,e,Ln)}function BE(){En(new Qt(Rp,FE,"PUBLIC").setMultipleInstances(!0)),ct(Dd,Ld,""),ct(Dd,Ld,"esm2020")}BE();const jE=$E(ic);function an(n){return(n||"").trim().toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,"")}function HE(n){return new Promise((e,t)=>{const i=new Image,s=new FileReader;s.onload=r=>{i.onload=()=>{let c=i.width,u=i.height;if(c>400||u>400){const L=Math.min(400/c,400/u);c=Math.round(c*L),u=Math.round(u*L)}const h=document.createElement("canvas");h.width=c,h.height=u,h.getContext("2d").drawImage(i,0,0,c,u);const v=150*1024;let b=.8;const C=()=>{h.toBlob(L=>{if(!L)return t(new Error("Canvas compression failed"));L.size<=v||b<=.3?e(L):(b-=.1,C())},"image/jpeg",b)};C()},i.onerror=()=>t(new Error("Failed to load image")),i.src=r.target.result},s.onerror=()=>t(new Error("Failed to read file")),s.readAsDataURL(n)})}async function so(n,e){var c;if(!f.hid)throw new Error("No household ID — cannot upload");if(!n)throw new Error("No file provided");const t=an(e);if(!t)throw new Error("Invalid product name for upload");let i;try{i=await HE(n),console.log(`[uploadProductImage] Compressed: ${(i.size/1024).toFixed(1)}KB, type=${i.type}`)}catch(u){throw console.error("[uploadProductImage] Compression failed:",u),new Error("Image compression failed — "+u.message)}const s=`households/${f.hid}/customProducts/${t}.jpg`,r=VE(jE,s);try{console.log(`[uploadProductImage] Uploading to: ${s}`),await OE(r,i,{contentType:"image/jpeg"}),console.log("[uploadProductImage] Upload succeeded")}catch(u){throw console.error("[uploadProductImage] Storage upload failed:",u.code,u.message),new Error("Storage upload failed — "+(u.code||u.message))}let o;try{o=await ME(r),console.log("[uploadProductImage] Download URL obtained")}catch(u){throw console.error("[uploadProductImage] getDownloadURL failed:",u.code,u.message),new Error("Could not get download URL — "+(u.code||u.message))}try{const u=Le();await K(`households/${f.hid}/customProducts/${t}`,{name:e.trim(),imageUrl:o,imageDismissed:!1,updatedAt:new Date().toISOString(),updatedBy:(u==null?void 0:u.displayName)||((c=u==null?void 0:u.email)==null?void 0:c.split("@")[0])||"Unknown"}),console.log(`[uploadProductImage] Saved to customProducts collection: ${t}`)}catch(u){console.error("[uploadProductImage] Firestore save failed:",u)}return o}let Ge=null,Zo=!1,Oi="",ea=!1;function qE(){if(!(window.SpeechRecognition||window.webkitSpeechRecognition))return;const e=p("shopAddMicOpt");e&&(e.style.display="")}function Nd(n){const e=p("micstatus");e&&e.classList.toggle("visible",n)}function Pp(){if(Zo&&Ge){ea=!0,Ge.stop();return}const n=window.SpeechRecognition||window.webkitSpeechRecognition;if(!n){P("Voice input not supported");return}Ge=new n,Ge.lang="en-US",Ge.interimResults=!0,Ge.maxAlternatives=1,Ge.continuous=!1,Oi="",Zo=!0,Nd(!0),Ge.onresult=e=>{let t="";for(let s=e.resultIndex;s<e.results.length;s++){const r=e.results[s][0].transcript;e.results[s].isFinal?Oi+=r:t+=r}const i=p("shi");i&&(i.value=(Oi+t).trim())},Ge.onerror=e=>{e.error!=="no-speech"&&e.error!=="aborted"&&P("Couldn't hear that — try again")},Ge.onend=()=>{let e=(Oi||"").trim();if(!e&&ea){const t=p("shi");e=t?t.value.trim():""}if(Zo=!1,Ge=null,Oi="",ea=!1,Nd(!1),e){let t=e,i=1;const s=e.match(/^(\d+)\s+(.+)/),r=e.match(/^(.+?)\s*[x×]\s*(\d+)$/i);r?(t=r[1].trim(),i=parseInt(r[2],10)||1):s&&(t=s[2].trim(),i=parseInt(s[1],10)||1);const o={id:Date.now().toString(),name:t,qty:i,checked:!1,src:"manual"};Ie(o),P(`Added "${e}" 🎤`);const c=p("shi");c&&(c.value=""),ro(o.id,t,"shop")}},Ge.start()}function xp(n){return n?n.replace(/\S+/g,e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()):""}function Dp(n){if(!n.brand)return!1;if(n.src==="scan")return!0;if(n.src==="search"&&n.searchQuery){const e=n.searchQuery.toLowerCase().split(/\s+/).filter(i=>i.length>=2),t=n.brand.toLowerCase();return e.some(i=>t.includes(i))}return!1}function Js(n){const e=n.qty||1,t=`<span class="sh-qty${e===1?" sh-qty-one":""}" onclick="event.stopPropagation();openShQty('${n.id}')"> × ${e}</span>`,i=n.image?`<img src="${n.image}" class="sh-thumb" alt="" onerror="this.style.display='none'"/>`:"";return`<div class="swipe-wrap" id="sw-${n.id}" data-id="${n.id}" data-list="shop">
    ...
    <div class="swipe-del" onclick="swipeDelItem('${n.id}','shop')">
      ...
      Just add "${e}" as typed
    </button>`,i.innerHTML=u,window._enrichCtx={itemId:n,query:e,list:t,results:c}}catch(c){console.warn("Text search failed:",c),Dr()}}function Dr(){const n=p("enrichBackdrop"),e=p("enrichSheet");n&&n.classList.remove("active"),e&&e.classList.remove("active"),window._enrichCtx=null}async function Pn(n){if(f.selectMode)return;event&&event.stopPropagation();const e=f.shop.find(b=>b.id===n);if(!e)return;const t=p("itemDetailContent");if(!t)return;let i=e.image;if(e.imageDismissed,f.hid&&e.name){const b=an(e.name);if(b){const C=await ae(`households/${f.hid}/customProducts/${b}`);C&&(C.imageDismissed?i=null:C.imageUrl&&(i=C.imageUrl))}}const s=i?`<div class="item-detail-img-wrap drop-zone" data-item-id="${e.id}">
