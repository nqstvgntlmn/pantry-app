 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}async function ar(t){return(await fetch(t,{credentials:"include"})).ok}const Ve={};function cr(){const t={prod:[],emulator:[]};for(const e of Object.keys(Ve))Ve[e]?t.emulator.push(e):t.prod.push(e);return t}function lr(t){let e=document.getElementById(t),n=!1;return e||(e=document.createElement("div"),e.setAttribute("id",t),n=!0),{created:n,element:e}}let jn=!1;function dr(t,e){if(typeof window>"u"||typeof document>"u"||!Rt(window.location.host)||Ve[t]===e||Ve[t]||jn)return;Ve[t]=e;function n(f){return`__firebase__banner__${f}`}const i="__firebase__banner",r=cr().prod.length>0;function o(){const f=document.getElementById(i);f&&f.remove()}function l(f){f.style.display="flex",f.style.background="#7faaf0",f.style.position="fixed",f.style.bottom="5px",f.style.left="5px",f.style.padding=".5em",f.style.borderRadius="5px",f.style.alignItems="center"}function d(f,y){f.setAttribute("width","24"),f.setAttribute("id",y),f.setAttribute("height","24"),f.setAttribute("viewBox","0 0 24 24"),f.setAttribute("fill","none"),f.style.marginLeft="-6px"}function u(){const f=document.createElement("span");return f.style.cursor="pointer",f.style.marginLeft="16px",f.style.fontSize="24px",f.innerHTML=" &times;",f.onclick=()=>{jn=!0,o()},f}function h(f,y){f.setAttribute("id",y),f.innerText="Learn more",f.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",f.setAttribute("target","__blank"),f.style.paddingLeft="5px",f.style.textDecoration="underline"}function m(){const f=lr(i),y=n("text"),_=document.getElementById(y)||document.createElement("span"),Y=n("learnmore"),Ee=document.getElementById(Y)||document.createElement("a"),Q=n("preprendIcon"),X=document.getElementById(Q)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(f.created){const w=f.element;l(w),h(Ee,Y);const S=u();d(X,Q),w.append(X,_,Ee,S),document.body.appendChild(w)}r?(_.innerText="Preview backend disconnected.",X.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function A(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function ur(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(A())}function hr(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function fr(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function pr(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function mr(){const t=A();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function gr(){try{return typeof indexedDB=="object"}catch{return!1}}function yr(){return new Promise((t,e)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var r;e(((r=s.error)==null?void 0:r.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo="firebase-heartbeat-database",Co=1,Qe="firebase-heartbeat-store";let Wt=null;function Hi(){return Wt||(Wt=jr(Eo,Co,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Qe)}catch(n){console.warn(n)}}}}).catch(t=>{throw pe.create("idb-open",{originalErrorMessage:t.message})})),Wt}async function To(t){try{const n=(await Hi()).transaction(Qe),i=await n.objectStore(Qe).get(Fi(t));return await n.done,i}catch(e){if(e instanceof me)ne.warn(e.message);else{const n=pe.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ne.warn(n.message)}}}async function Gn(t,e){try{const i=(await Hi()).transaction(Qe,"readwrite");await i.objectStore(Qe).put(e,Fi(t)),await i.done}catch(n){if(n instanceof me)ne.warn(n.message);else{const i=pe.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});ne.warn(i.message)}}}function Fi(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Do(t){Ye(new $e("platform-logger",e=>new qr(e),"PRIVATE")),Ye(new $e("heartbeat",e=>new Lo(e),"PRIVATE")),Te(tn,Wn,t),Te(tn,Wn,"esm2020"),Te("fire-js","")}Do("");var No="firebase",Oo="12.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ni(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Xi(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ji(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(es(e))return"Blackberry";if(ts(e))return"Webos";if(Yi(e))return"Safari";if((e.includes("chrome/")||Qi(e))&&!e.includes("edge/"))return"Chrome";if(Zi(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Ji(t=A()){return/firefox\//i.test(t)}function Yi(t=A()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Qi(t=A()){return/crios\//i.test(t)}function Xi(t=A()){return/iemobile/i.test(t)}function Zi(t=A()){return/android/i.test(t)}function es(t=A()){return/blackberry/i.test(t)}function ts(t=A()){return/webos/i.test(t)}function bn(t=A()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function ia(t=A()){var e;return bn(t)&&!!((e=window.navigator)!=null&&e.standalone)}function sa(){return mr()&&document.documentMode===10}function ns(t=A()){return bn(t)||Zi(t)||ts(t)||es(t)||/windows phone/i.test(t)||Xi(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function is(t,e=[]){let n;switch(t){case"Browser":n=ni(A());break;case"Worker":n=`${ni(A())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${st}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oe extends Pt{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}class Ke extends Oe{static credentialFromJSON(e){const n=typeof e=="string"?JSON.parse(e):e;return g("providerId"in n&&"signInMethod"in n,"argument-error"),se._fromParams(n)}credential(e){return this._credential({...e,nonce:e.rawNonce})}_credential(e){return g(e.idToken||e.accessToken,"argument-error"),se._fromParams({...e,providerId:this.providerId,signInMethod:this.providerId})}static credentialFromResult(e){return Ke.oauthCredentialFromTaggedObject(e)}static credentialFromError(e){return Ke.oauthCredentialFromTaggedObject(e.customData||{})}static oauthCredentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:n,oauthAccessToken:i,oauthTokenSecret:s,pendingToken:r,nonce:o,providerId:l}=e;if(!i&&!s&&!n&&!r||!l)return null;try{return new Ke(l)._credential({idToken:n,accessToken:i,nonce:o,pendingToken:r})}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wc(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Kc(t){Ye(new $e("auth",(e,{options:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:l}=i.options;g(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const d={apiKey:o,authDomain:l,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:is(t)},u=new la(i,s,r,d);return wa(u,n),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,i)=>{e.getProvider("auth-internal").initialize()})),Ye(new $e("auth-internal",e=>{const n=J(e.getProvider("auth").getImmediate());return(i=>new Vc(i))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Te(fi,pi,Wc(t)),Te(fi,pi,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`);navigator.share?navigator.share({title:"Shopping List",text:n}).catch(()=>{}):navigator.clipboard&&navigator.clipboard.writeText(n).then(()=>p("List copied!"))}function Xl(){const t=a.shop.filter(n=>n.checked);if(!t.length){p("No completed items!");return}const e=c("atk-body");e.innerHTML=`<div style="padding:16px">
  ...
  </div>`,ye("atk")}function Zl(t,e,n){const i=c("atk-"+t);i.dataset.loc=e,i.querySelectorAll(".atk-loc button").forEach(s=>s.classList.remove("sel")),n.classList.add("sel")}async function ed(){const t=a.shop.filter(i=>i.checked),e=new Date().toLocaleDateString();let n=0;for(const i of t){const s=c("atk-"+i.id);if(!s)continue;const r=s.dataset.loc||Rs(i.name),o=a.inv.find(d=>d.name.toLowerCase()===i.name.toLowerCase()),l=i.qty||1;await oe({id:o?o.id:"inv-"+Date.now()+"-"+Math.random().toString(36).slice(2),name:o?o.name:i.name,qty:o?o.qty+l:l,unit:o?o.unit:"unit",location:r,category:o?o.category:Ze({name:i.name}),addedAt:o?o.addedAt:e,brand:o?o.brand:"",expiry:o?o.expiry:null,image:o?o.image:null,source:"shopping"}),await Mt(i.id),n++}L("atk"),p(`${n} item${n!==1?"s":""} added to your kitchen! 🧺`)}async function td(){const t=He().map(s=>{const r=s.toISOString().split("T")[0];return a.mp[r]?`${s.toLocaleDateString("en-US",{weekday:"short"})}: ${a.mp[r]}`:""}).filter(Boolean).join(", ");if(!t){p("No meals planned yet!");return}const e=a.inv.map(s=>`${s.name} (${s.qty} ${s.unit})`).join(", "),n=document.querySelector('[onclick="buildList()"]'),i=n?n.textContent:"";n&&(n.disabled=!0,n.textContent="⏳ Thinking…");try{const r=await(await fetch("/api/proxy",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-haiku-4-5-20251001",max_tokens:500,messages:[{role:"user",content:`Week meals: ${t}
Already have: ${e}
...
Recipe: ${e.description}`}]})})).json(),r=(s.content&&s.content[0]&&s.content[0].text||"").replace(/```json|```/g,"").trim(),l=JSON.parse(r).filter(d=>!n.some(u=>u.includes(d.toLowerCase())||d.toLowerCase().includes(u)));if(!l.length){p("All ingredients already in pantry ✓");return}for(const d of l)await ae({id:"shop-"+Date.now()+"-"+Math.random().toString(36).slice(2),name:d,qty:1,checked:!1,src:"recipe"});p(`Added ${l.length} ingredient${l.length!==1?"s":""} to shopping list 🛒`),L("erec"),window.showScreen("shopping")}catch{p("Couldn't parse ingredients")}}function Id(t,e){a.nr=t,e==="r"?Je("rstars",t):e==="c"?Je("cstars",t):e==="e"&&Je("estars",t)}async function _d(t){const e=a.recs.find(r=>r.id===t);if(!e)return;const n=!e.isPublic,i=D(),s=(i==null?void 0:i.displayName)||localStorage.getItem("ks-who")||"Anonymous";n?(await ml(e,s,a.hid),p("Recipe shared with the community!")):(await gl(e.id),p("Recipe removed from community")),await Ie({...e,isPublic:n})}async function Dn(){const t=c("rbody");if(t){t.innerHTML='<div class="es"><div class="ei">🌍</div><p>Loading community recipes…</p></div>';try{a.comRecs=await yl(),Nn()}catch(e){console.error("loadCommunity:",e),t.innerHTML=`<div class="es"><div class="ei">⚠️</div><p>Couldn't load community recipes.</p></div>`}}}function Sd(t){a.comCuisine=t,Nn()}function Ed(t){a.comSearch=t,Nn()}function Nn(){const t=c("rbody");if(!t)return;let e=[...a.comRecs];if(a.comCuisine&&a.comCuisine!=="all"&&(e=e.filter(s=>(s.cuisine||"").toLowerCase().includes(a.comCuisine.toLowerCase())||(s.tags||[]).some(r=>r.toLowerCase().includes(a.comCuisine.toLowerCase())))),a.comSearch){const s=a.comSearch.toLowerCase();e=e.filter(r=>(r.title||"").toLowerCase().includes(s)||(r.tags||[]).join(" ").toLowerCase().includes(s)||(r.cuisine||"").toLowerCase().includes(s)||(r.authorName||"").toLowerCase().includes(s))}e.sort((s,r)=>new Date(r.createdAt||0)-new Date(s.createdAt||0));const n=c("rsub");n&&(n.textContent=e.length+" community recipe"+(e.length!==1?"s":""));let i=`<div style="margin-bottom:14px">
    ...
    <div style="margin-top:16px;padding:12px;background:var(--card);border:1px solid var(--b1);border-radius:12px">
    ...
    </div>`,ye("erec")}async function Td(t){if(!D()){p("Sign in to like recipes");return}const n=a.myLikes.has(t);try{await vl(t,n),n?a.myLikes.delete(t):a.myLikes.add(t);const i=a.comRecs.find(r=>r.id===t);i&&(i.likes=(i.likes||0)+(n?-1:1));const s=c("com-like-btn");if(s){const r=a.myLikes.has(t);s.className=`btn ${r?"bp":"bs"} bsm`,s.innerHTML=`${r?"❤️":"🤍"} ${(i==null?void 0:i.likes)||0} Like${((i==null?void 0:i.likes)||0)!==1?"s":""}`}p(n?"Like removed":"Liked!")}catch(i){console.error("likeComRecipe:",i),p("Couldn't update like")}}async function xd(t){if(!D()){p("Sign in to save recipes");return}const n=a.comRecs.find(i=>i.id===t);if(n)try{await Il(n),p("Recipe saved to your kitchen! 📖"),L("erec")}catch(i){console.error("saveComToKitchen:",i),p("Couldn't save recipe")}}async function Ad(t){var r;const e=D();if(!e){p("Sign in to comment");return}const n=c("com-cmt-input"),i=(r=n==null?void 0:n.value)==null?void 0:r.trim();if(!i)return;const s=e.displayName||localStorage.getItem("ks-who")||"Anonymous";try{const o=await wl(t,i,s);n.value="";const l=c("com-comments");l&&o&&(l.querySelector("div[style*='color:var(--mt)']")&&!l.querySelector("div[style*='border-bottom']")&&(l.innerHTML=""),l.innerHTML+=`<div style="padding:10px 0;border-bottom:1px solid var(--b1)">
        <div style="display:flex;justify-content:space-between;align-items:center">
      ...
      </div>`),p("Comment posted!")}catch(o){console.error("addComComment:",o),p("Couldn't post comment")}}async function Ld(t){const e=a.comRecs.find(s=>s.id===t),n=`https://pantry-app-zeta-six.vercel.app/recipe/${t}`,i=(e==null?void 0:e.title)||"Recipe";if(navigator.share)try{await navigator.share({title:i,text:`Check out this recipe: ${i}`,url:n});return}catch{}try{await navigator.clipboard.writeText(n),p("Link copied!")}catch{p("Couldn't copy link")}}function Rd(){const t=a.cookLog,e=a.wasteLog;let n=0;for(let w=0;w<60;w++){const S=new Date;S.setDate(S.getDate()-w);const R=S.toISOString().split("T")[0];if(t.find(U=>U.date===R))n++;else if(w>0)break}const i=c("ins-streak-num");i&&(i.textContent=n);const s=c("ins-total-cooked");s&&(s.textContent=t.length);const r=c("ins-waste-count");r&&(r.textContent=e.length);const o=c("ins-sub");o&&(o.textContent=t.length?" "+t.length+" meals cooked":"Your kitchen at a glance");const l=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],d=c("ins-week");if(d){const w=He().map(S=>{const R=S.toISOString().split("T")[0],U=a.mp[R],E=R===he();return`<div style="display:flex;align-items:center;gap:10px;padding:7px 0;border-bottom:1px solid var(--b1)${E?";background:var(--acd);margin:0 -4px;padding:7px 4px;border-radius:6px":""}">
      ...
      </div>`}).join("");d.innerHTML=w}const u=t.slice(0,7).map(w=>w.name),h=c("ins-variety-nudge"),m=c("ins-variety-msg");if(h&&u.length>=3){const w={};u.forEach(I=>{const je=I.toLowerCase();w[je]=(w[je]||0)+1});const S=Object.entries(w).filter(([,I])=>I>=3),R=Object.values(a.mp).filter(Boolean),U=R.some(I=>/curry|dal|rice|bengali|biryani|hilsa|mustard|lentil/i.test(I)),E=R.some(I=>/kebab|köfte|pide|börek|meze|turkish|pilav|lahmacun/i.test(I));S.length?(h.style.display="block",m.textContent=`You've cooked "${S[0][0]}" ${S[0][1]} times this week. Time to mix it up?`):!U&&R.length>=3?(h.style.display="block",m.textContent="No Bangladeshi dishes this week — how about a dal, biryani, or fish curry?"):!E&&R.length>=3?(h.style.display="block",m.textContent="No Turkish dishes planned — köfte, mercimek çorbası, or a pilav would be great this week!"):h.style.display="none"}else h&&(h.style.display="none");const f={};t.forEach(w=>{f[w.name]=(f[w.name]||0)+1});const y=Object.entries(f).sort((w,S)=>S[1]-w[1]).slice(0,6),_=y[0]?y[0][1]:1,Y=c("ins-cooked");if(Y)if(!y.length)Y.innerHTML='<div class="es" style="padding:16px"><p>Cook some meals to see stats!</p></div>';else{const w=["🥇","🥈","🥉","4️⃣","5️⃣","6️⃣"];Y.innerHTML=y.map(([S,R],U)=>`<div class="ibar-row"><div style="font-size:.9rem;margin-right:4px">${w[U]||""}</div><div class="ibar-lbl">${S}</div><div class="ibar-track"><div class="ibar-fill" style="width:${Math.round(R/_*100)}%"></div></div><div class="ibar-val">${R}×</div></div>`).join("")}const Ee={Bangladeshi:"#e8a44a",Turkish:"#c0392b",Mediterranean:"#27ae60",American:"#3498db",Italian:"#e74c3c",Asian:"#9b59b6",Other:"#95a5a6"},Q=c("ins-cuisine");if(Q&&t.length){const w=E=>{const I=E.toLowerCase();return/dal|curry|biryani|hilsa|mustard|bengali|lentil|khichuri|pulao|bhuna/i.test(I)?"Bangladeshi":/kebab|köfte|pide|börek|meze|pilav|lahmacun|mercimek|döner|iskender/i.test(I)?"Turkish":/pasta|pizza|risotto|gnocchi|italian/i.test(I)?"Italian":/tacos|burrito|enchilada|mexican/i.test(I)?"Mexican":/sushi|ramen|stir.?fry|fried rice|asian|chinese|thai|japanese/i.test(I)?"Asian":/burger|sandwich|mac|bbq|american/i.test(I)?"American":"Other"},S={};t.slice(0,20).forEach(E=>{const I=w(E.name);S[I]=(S[I]||0)+1});const R=Object.values(S).reduce((E,I)=>E+I,0),U=Object.entries(S).sort((E,I)=>I[1]-E[1]);Q.innerHTML=U.map(([E,I])=>{const je=Math.round(I/R*100),Ys=Ee[E]||"#95a5a6";return`<div style="margin-bottom:10px"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px"><span style="font-size:.82rem;font-weight:500">${E}</span><span style="font-size:.74rem;color:var(--mt)">${I} meals · ${je}%</span></div><div style="height:8px;background:var(--b1);border-radius:4px;overflow:hidden"><div style="height:100%;width:${je}%;background:${Ys};border-radius:4px;transition:width .6s ease"></div></div></div>`}).join("")||'<div class="es" style="padding:16px"><p>Cook more meals to see your cuisine breakdown.</p></div>'}const X=c("ins-waste");X&&(X.innerHTML=e.length?e.slice(0,10).map(w=>`<div class="waste-item"><span style="font-size:.86rem">${w.name}</span><span style="font-size:.74rem;color:var(--rd)">${w.date}</span></div>`).join(""):'<div class="es" style="padding:16px"><p>Nothing wasted yet — great job! 🎉</p></div>')}function $d(){const t=["fridge","freezer","pantry"].map(o=>{const l=a.inv.filter(d=>d.location===o);return l.length?xn(o).toUpperCase()+": "+l.map(d=>`${d.name} (${d.qty} ${d.unit})`).join(", "):""}).filter(Boolean).join(`
`),e=a.inv.filter(o=>{const l=K(o.expiry);return l&&(l.c==="expiring"||l.c==="expired")}).map(o=>{const l=K(o.expiry);return`${o.name} (${l.l})`}).join(", "),n=He().map(o=>{const l=o.toISOString().split("T")[0];return a.mp[l]?`${o.toLocaleDateString("en-US",{weekday:"short"})}: ${a.mp[l]}`:""}).filter(Boolean).join(", "),i=a.recs.filter(o=>o.favorited||o.rating>=4).map(o=>`${o.name}${o.rating?` (${o.rating}★)`:""}`).join(", "),s=[a.cfg.nopork?"no pork":null,a.cfg.noshellfish?"no shellfish":null,a.cfg.vegetarian?"vegetarian":null,a.cfg.glutenfree?"gluten-free":null,a.cfg.other].filter(Boolean).join(", "),r=a.cookLog.slice(0,7).map(o=>o.name).join(", ");return`You are a helpful kitchen assistant for a family in Edison NJ.
INVENTORY:
${t||"Empty."}
${e?"EXPIRING SOON: "+e:""}
${n?"MEAL PLAN: "+n:""}
